    ...
    35113: function (e, t, r) {
      ...
      function s(e, t) {
        ...
        e instanceof Promise
          ...
          : "function" == typeof e
          ? (a.loader = e)
          : "object" == typeof e && (a = n._({}, a, e));
        var s = (a = n._({}, a, t)).loader;
        return (a.loadableGenerated &&
          ((a = n._({}, a, a.loadableGenerated)), delete a.loadableGenerated),
        "boolean" != typeof a.ssr || a.ssr)
          ...
          : (delete a.webpack, delete a.modules, l(r, a));
      }
      ...
      function m(e) {
        return (function (e, t) {
          var r = function () {
            ...
            u = function (e, t) {
              n();
              var r = i.default.useSyncExternalStore(
                o.subscribe,
                o.getCurrentValue,
                o.getCurrentValue,
              );
    ...
    7813: function (e, t, r) {
      ...
      var n,
        ...
        T =
          ...
          n),
        P =
          (((u = P || {})[(u.Pointer = 0)] = "Pointer"),
          (u[(u.Other = 1)] = "Other"),
          u),
        S =
          (((a = S || {})[(a.OpenMenu = 0)] = "OpenMenu"),
      ...
      function k(e, t = (e) => e) {
        ...
        return -1 === u && (u = null), { items: n, activeItemIndex: u };
      }
      let w = {
          1: (e) =>
            1 === e.menuState
          ...
          5: (e, t) => {
            let r = k(e, (e) => [...e, { id: t.id, dataRef: t.dataRef }]);
            return { ...e, ...r };
          },
          6: (e, t) => {
            let r = k(e, (e) => {
      ...
      let O = o.Fragment,
        C = (0, l.yV)(function (e, t) {
          let r = (0, o.useReducer)(D, {
              menuState: 1,
          ...
          (0, h.O)(
            ...
            (e, t) => {
              ...
              s({ type: 1 }),
                (0, b.sP)(t, b.tJ.Loose) ||
                  (e.preventDefault(), null == (r = a.current) || r.focus());
            },
            0 === n,
          );
          let d = (0, o.useMemo)(() => ({ open: 0 === n }), [n]);
          return o.createElement(
            M.Provider,
            { value: r },
            o.createElement(
              _.up,
              { value: (0, i.E)(n, { 0: _.ZM.Open, 1: _.ZM.Closed }) },
              (0, l.sY)({
                ourProps: { ref: c },
                theirProps: e,
                slot: d,
        ...
        N = (0, l.yV)(function (e, t) {
          ...
          let [n, u] = E("Menu.Button"),
            a = (0, f.T)(n.buttonRef, t),
            i = `headlessui-menu-button-${(0, p.M)()}`,
            s = (0, c.G)(),
            d = (0, x.z)((e) => {
              switch (e.key) {
                case m.R.Space:
                ...
                case m.R.ArrowDown:
                  e.preventDefault(),
                    e.stopPropagation(),
                    u({ type: 0 }),
                    s.nextFrame(() => u({ type: 2, focus: v.T.First }));
                  break;
                case m.R.ArrowUp:
                  e.preventDefault(),
                    e.stopPropagation(),
                    u({ type: 0 }),
                    s.nextFrame(() => u({ type: 2, focus: v.T.Last }));
              }
            }),
            b = (0, x.z)((e) => {
            ...
            h = (0, x.z)((t) => {
              if ((0, y.P)(t.currentTarget)) return t.preventDefault();
              e.disabled ||
                (0 === n.menuState
                  ? (u({ type: 1 }),
                    s.nextFrame(() => {
            ...
            g = (0, o.useMemo)(() => ({ open: 0 === n.menuState }), [n]),
            _ = {
              ref: a,
              id: i,
              type: (0, I.f)(e, n.buttonRef),
              "aria-haspopup": !0,
        ...
        L = (0, l.yV)(function (e, t) {
          var r, n;
          let [u, a] = E("Menu.Items"),
            i = (0, f.T)(u.itemsRef, t),
            y = (0, R.i)(u.itemsRef),
            h = `headlessui-menu-items-${(0, p.M)()}`,
            I = (0, c.G)(),
            T = (0, _.oJ)(),
            ...
            (function ({ container: e, accept: t, walk: r, enabled: n = !0 }) {
              ...
              (0, o.useEffect)(() => {
                ...
                (0, d.e)(() => {
                  ...
                  let r = u.current,
                    o = a.current,
                    i = Object.assign((e) => r(e), { acceptNode: r }),
          ...
          let S = (0, x.z)((e) => {
              ...
              switch ((I.dispose(), e.key)) {
                ...
                default:
                  1 === e.key.length &&
                    (a({ type: 3, value: e.key }),
                    I.setTimeout(() => a({ type: 4 }), 350));
              }
            }),
            k = (0, x.z)((e) => {
              e.key === m.R.Space && e.preventDefault();
            }),
            w = (0, o.useMemo)(() => ({ open: 0 === u.menuState }), [u]),
            M = {
              "aria-activedescendant":
                null === u.activeItemIndex ||
                null == (r = u.items[u.activeItemIndex])
                  ? void 0
                  : r.id,
              "aria-labelledby":
                null == (n = u.buttonRef.current) ? void 0 : n.id,
              id: h,
              onKeyDown: S,
              onKeyUp: k,
              role: "menu",
        ...
        j = Object.assign(C, {
          ...
          Item: (0, l.yV)(function (e, t) {
            let { disabled: r = !1, ...n } = e,
              [u, a] = E("Menu.Item"),
              i = `headlessui-menu-item-${(0, p.M)()}`,
              c =
                null !== u.activeItemIndex &&
                u.items[u.activeItemIndex].id === i,
              m = (0, o.useRef)(null),
              y = (0, f.T)(t, m);
            (0, d.e)(() => {
              if (0 !== u.menuState || !c || 0 === u.activationTrigger) return;
              let e = (0, s.k)();
              return (
            ...
            let h = (0, o.useRef)({ disabled: r, domRef: m });
            (0, d.e)(() => {
              ...
              (0, d.e)(
                () => (
                  a({ type: 5, id: i, dataRef: h }), () => a({ type: 6, id: i })
                ),
                [h, i],
              );
            let g = (0, x.z)((e) => {
                if (r) return e.preventDefault();
                a({ type: 1 }), (0, b.wI)(u.buttonRef.current);
              }),
              _ = (0, x.z)(() => {
                if (r) return a({ type: 2, focus: v.T.Nothing });
                a({ type: 2, focus: v.T.Specific, id: i });
              }),
              I = (0, x.z)(() => {
                r ||
                  c ||
                  a({ type: 2, focus: v.T.Specific, id: i, trigger: 0 });
              }),
              R = (0, x.z)(() => {
                r || !c || a({ type: 2, focus: v.T.Nothing });
              }),
              T = (0, o.useMemo)(() => ({ active: c, disabled: r }), [c, r]);
            return (0, l.sY)({
              ourProps: {
                id: i,
                ref: y,
