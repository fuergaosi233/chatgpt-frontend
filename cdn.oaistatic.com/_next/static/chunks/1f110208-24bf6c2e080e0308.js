    ...
    75927: function (e, t, r) {
        ...
        static range(e, t) {
          return t
            ? e && e.loc && t.loc && e.loc.lexer === t.loc.lexer
              ? new a(e.loc.lexer, e.loc.start, t.loc.end)
              : null
            : e && e.loc;
        }
      }
        ...
        constructor(e, t) {
          ...
          if (a && a.start <= a.end) {
            ...
            n === s.length
              ? (r += " at end of input: ")
              : (r += " at position " + (n + 1) + ": ");
            var l = s.slice(n, o).replace(/[^]/g, "$&̲");
            r +=
              (n > 15 ? "…" + s.slice(n - 15, n) : s.slice(0, n)) +
              l +
              (o + 15 < s.length ? s.slice(o, o + 15) + "…" : s.slice(o));
          }
          var h = Error(r);
          return (
            (h.name = "ParseError"),
            (h.__proto__ = i.prototype),
            (h.position = n),
            h
          );
        }
      ...
      var s,
        ...
        x = {
          ...
          escape: function (e) {
            return String(e).replace(v, (e) => f[e]);
          },
      ...
      class k {
        ...
        reportNonstrict(e, t, r) {
          var a = this.strict;
          if (
            ("function" == typeof a && (a = a(e, t, r)), a && "ignore" !== a)
          ) {
            if (!0 === a || "error" === a)
              throw new i(
        ...
        isTrusted(e) {
          return (
            ...
            !!("function" == typeof this.trust ? this.trust(e) : this.trust)
          );
        }
      }
      class S {
      ...
      var M = [
        ...
        C = [1, 1, 3, 3, 5, 5, 7, 7],
        q = [0, 1, 2, 3, 2, 3, 2, 3],
        N = { DISPLAY: M[0], TEXT: M[2], SCRIPT: M[4], SCRIPTSCRIPT: M[6] },
        I = [
          {
            name: "latin",
            blocks: [
      ...
      function O(e) {
        for (var t = 0; t < R.length; t += 2)
          if (e >= R[t] && e <= R[t + 1]) return !0;
        return !1;
      }
      I.forEach((e) => e.blocks.forEach((e) => R.push(...e)));
      ...
      function G(e, t, r) {
        if (!P[t]) throw Error("Font metrics not found for font: " + t + ".");
        var a = e.charCodeAt(0),
          n = P[t][a];
        if (
          (!n && e[0] in V && ((a = V[e[0]].charCodeAt(0)), (n = P[t][a])),
          !n && "text" === r && O(a) && (n = P[t][77]),
          n)
        )
          return {
            depth: n[0],
      ...
      var U = {},
        ...
        X = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
        W = function (e, t) {
          return t.size < 2 ? e : Y[e - 1][t.size - 1];
        };
      class _ {
        constructor(e) {
          (this.style = void 0),
            ...
            (this.sizeMultiplier = X[this.size - 1]),
        ...
        havingStyle(e) {
          return this.style === e
            ? this
            : this.extend({ style: e, size: W(this.textSize, e) });
        }
        havingCrampedStyle() {
        ...
        havingSize(e) {
          return this.size === e && this.textSize === e
            ...
            : this.extend({
                ...
                size: e,
                textSize: e,
                sizeMultiplier: X[e - 1],
              });
        }
        havingBaseStyle(e) {
          e = e || this.style.text();
          var t = W(_.BASESIZE, e);
          return this.size === t &&
            this.textSize === _.BASESIZE &&
            this.style === e
            ? this
        ...
        baseSizingClasses() {
          return this.size !== _.BASESIZE
            ? ["sizing", "reset-size" + this.size, "size" + _.BASESIZE]
            : [];
        }
        fontMetrics() {
          return (
            this._fontMetrics ||
              (this._fontMetrics = (function (e) {
                var t;
                if (!U[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                  var r = (U[t] = { cssEmPerMu: F.quad[t] / 18 });
                  for (var a in F) F.hasOwnProperty(a) && (r[a] = F[a][t]);
                }
                return U[t];
              })(this.size)),
            this._fontMetrics
      ...
      var j = {
        ...
        Z = function (e) {
          return (
            "string" != typeof e && (e = e.unit), e in j || e in $ || "ex" === e
          );
        },
        K = function (e, t) {
          var r, a;
          if (e.unit in j)
            r = j[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
            ...
            else if ("em" === e.unit) r = a.fontMetrics().quad;
        ...
        et = function (e) {
          ...
          for (var r in ((t.className = Q(this.classes)), this.style))
        ...
        er = function (e) {
          var t = "<" + e;
          this.classes.length &&
            (t += ' class="' + x.escape(Q(this.classes)) + '"');
          var r = "";
          for (var a in this.style)
            this.style.hasOwnProperty(a) &&
              (r += x.hyphenate(a) + ":" + this.style[a] + ";");
          for (var n in (r && (t += ' style="' + x.escape(r) + '"'),
          this.attributes))
            this.attributes.hasOwnProperty(n) &&
              (t += " " + n + '="' + x.escape(this.attributes[n]) + '"');
          t += ">";
        ...
        toMarkup() {
          ...
          for (var r in this.style)
            this.style.hasOwnProperty(r) &&
              (t += x.hyphenate(r) + ":" + this.style[r] + ";");
          return t && (e += ' style="' + x.escape(t) + '"'), (e += "'/>");
        }
      }
      var es = { î: "ı̂", ï: "ı̈", í: "ı́", ì: "ı̀" };
      class eo {
        constructor(e, t, r, a, n, i, s, o) {
          ...
          var l = (function (e) {
            for (var t = 0; t < I.length; t++)
              for (var r = I[t], a = 0; a < r.blocks.length; a++) {
                var n = r.blocks[a];
          ...
          l && this.classes.push(l + "_fallback"),
            /[îïíì]/.test(this.text) && (this.text = es[this.text]);
        }
        hasClass(e) {
          return x.contains(this.classes, e);
        }
        toNode() {
          ...
          this.style))
            this.style.hasOwnProperty(r) &&
              ((t = t || document.createElement("span")).style[r] =
                this.style[r]);
        ...
        toMarkup() {
          var e = !1,
            t = "<span";
          this.classes.length &&
            ((e = !0), (t += ' class="' + x.escape(Q(this.classes)) + '"'));
          var r = "";
        ...
        toNode() {
          ...
          return (
            this.alternate
              ...
              : e.setAttribute("d", L[this.pathName]),
            e
          );
        }
        toMarkup() {
      ...
      var ep = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
        eu = {
          "accent-token": 1,
          mathord: 1,
          "op-token": 1,
        ...
        ed = { math: {}, text: {} };
      function eg(e, t, r, a, n, i) {
        (ed[e][n] = { font: t, group: r, replace: a }),
          i && a && (ed[e][a] = ed[e][n]);
      }
      var ef = "math",
        ev = "text",
        ...
        eA = "spacing",
        eT = "textord";
      eg(ef, eb, "rel", "≡", "\\equiv", !0),
        eg(ef, eb, "rel", "≺", "\\prec", !0),
        eg(ef, eb, "rel", "≻", "\\succ", !0),
        eg(ef, eb, "rel", "∼", "\\sim", !0),
        eg(ef, eb, "rel", "⊥", "\\perp"),
        eg(ef, eb, "rel", "⪯", "\\preceq", !0),
        eg(ef, eb, "rel", "⪰", "\\succeq", !0),
        eg(ef, eb, "rel", "≃", "\\simeq", !0),
        eg(ef, eb, "rel", "∣", "\\mid", !0),
        eg(ef, eb, "rel", "≪", "\\ll", !0),
        eg(ef, eb, "rel", "≫", "\\gg", !0),
        eg(ef, eb, "rel", "≍", "\\asymp", !0),
        eg(ef, eb, "rel", "∥", "\\parallel"),
        eg(ef, eb, "rel", "⋈", "\\bowtie", !0),
        eg(ef, eb, "rel", "⌣", "\\smile", !0),
        eg(ef, eb, "rel", "⊑", "\\sqsubseteq", !0),
        eg(ef, eb, "rel", "⊒", "\\sqsupseteq", !0),
        eg(ef, eb, "rel", "≐", "\\doteq", !0),
        eg(ef, eb, "rel", "⌢", "\\frown", !0),
        eg(ef, eb, "rel", "∋", "\\ni", !0),
        eg(ef, eb, "rel", "∝", "\\propto", !0),
        eg(ef, eb, "rel", "⊢", "\\vdash", !0),
        eg(ef, eb, "rel", "⊣", "\\dashv", !0),
        eg(ef, eb, "rel", "∋", "\\owns"),
        eg(ef, eb, ez, ".", "\\ldotp"),
        eg(ef, eb, ez, "⋅", "\\cdotp"),
        eg(ef, eb, eT, "#", "\\#"),
        ...
        eg(ef, eb, eT, "&", "\\&"),
        eg(ev, eb, eT, "&", "\\&"),
        eg(ef, eb, eT, "ℵ", "\\aleph", !0),
        eg(ef, eb, eT, "∀", "\\forall", !0),
        eg(ef, eb, eT, "ℏ", "\\hbar", !0),
        eg(ef, eb, eT, "∃", "\\exists", !0),
        eg(ef, eb, eT, "∇", "\\nabla", !0),
        eg(ef, eb, eT, "♭", "\\flat", !0),
        eg(ef, eb, eT, "ℓ", "\\ell", !0),
        eg(ef, eb, eT, "♮", "\\natural", !0),
        eg(ef, eb, eT, "♣", "\\clubsuit", !0),
        eg(ef, eb, eT, "℘", "\\wp", !0),
        eg(ef, eb, eT, "♯", "\\sharp", !0),
        eg(ef, eb, eT, "♢", "\\diamondsuit", !0),
        eg(ef, eb, eT, "ℜ", "\\Re", !0),
        eg(ef, eb, eT, "♡", "\\heartsuit", !0),
        eg(ef, eb, eT, "ℑ", "\\Im", !0),
        eg(ef, eb, eT, "♠", "\\spadesuit", !0),
        eg(ef, eb, eT, "\xa7", "\\S", !0),
        eg(ev, eb, eT, "\xa7", "\\S"),
        eg(ef, eb, eT, "\xb6", "\\P", !0),
        eg(ev, eb, eT, "\xb6", "\\P"),
        eg(ef, eb, eT, "†", "\\dag"),
        eg(ev, eb, eT, "†", "\\dag"),
        eg(ev, eb, eT, "†", "\\textdagger"),
        eg(ef, eb, eT, "‡", "\\ddag"),
        eg(ev, eb, eT, "‡", "\\ddag"),
        eg(ev, eb, eT, "‡", "\\textdaggerdbl"),
        eg(ef, eb, ex, "⎱", "\\rmoustache", !0),
        eg(ef, eb, eM, "⎰", "\\lmoustache", !0),
        eg(ef, eb, ex, "⟯", "\\rgroup", !0),
        eg(ef, eb, eM, "⟮", "\\lgroup", !0),
        eg(ef, eb, "bin", "∓", "\\mp", !0),
        eg(ef, eb, "bin", "⊖", "\\ominus", !0),
        eg(ef, eb, "bin", "⊎", "\\uplus", !0),
        eg(ef, eb, "bin", "⊓", "\\sqcap", !0),
        eg(ef, eb, "bin", "∗", "\\ast"),
        eg(ef, eb, "bin", "⊔", "\\sqcup", !0),
        eg(ef, eb, "bin", "◯", "\\bigcirc", !0),
        eg(ef, eb, "bin", "∙", "\\bullet", !0),
        eg(ef, eb, "bin", "‡", "\\ddagger"),
        eg(ef, eb, "bin", "≀", "\\wr", !0),
        eg(ef, eb, "bin", "⨿", "\\amalg"),
        eg(ef, eb, "bin", "&", "\\And"),
        eg(ef, eb, "rel", "⟵", "\\longleftarrow", !0),
        eg(ef, eb, "rel", "⇐", "\\Leftarrow", !0),
        eg(ef, eb, "rel", "⟸", "\\Longleftarrow", !0),
        eg(ef, eb, "rel", "⟶", "\\longrightarrow", !0),
        eg(ef, eb, "rel", "⇒", "\\Rightarrow", !0),
        eg(ef, eb, "rel", "⟹", "\\Longrightarrow", !0),
        eg(ef, eb, "rel", "↔", "\\leftrightarrow", !0),
        eg(ef, eb, "rel", "⟷", "\\longleftrightarrow", !0),
        eg(ef, eb, "rel", "⇔", "\\Leftrightarrow", !0),
        eg(ef, eb, "rel", "⟺", "\\Longleftrightarrow", !0),
        eg(ef, eb, "rel", "↦", "\\mapsto", !0),
        eg(ef, eb, "rel", "⟼", "\\longmapsto", !0),
        eg(ef, eb, "rel", "↗", "\\nearrow", !0),
        eg(ef, eb, "rel", "↩", "\\hookleftarrow", !0),
        eg(ef, eb, "rel", "↪", "\\hookrightarrow", !0),
        eg(ef, eb, "rel", "↘", "\\searrow", !0),
        eg(ef, eb, "rel", "↼", "\\leftharpoonup", !0),
        eg(ef, eb, "rel", "⇀", "\\rightharpoonup", !0),
        eg(ef, eb, "rel", "↙", "\\swarrow", !0),
        eg(ef, eb, "rel", "↽", "\\leftharpoondown", !0),
        eg(ef, eb, "rel", "⇁", "\\rightharpoondown", !0),
        eg(ef, eb, "rel", "↖", "\\nwarrow", !0),
        eg(ef, eb, "rel", "⇌", "\\rightleftharpoons", !0),
        eg(ef, "ams", "rel", "≮", "\\nless", !0),
        eg(ef, "ams", "rel", "", "\\@nleqslant"),
        eg(ef, "ams", "rel", "", "\\@nleqq"),
        eg(ef, "ams", "rel", "⪇", "\\lneq", !0),
        eg(ef, "ams", "rel", "≨", "\\lneqq", !0),
        eg(ef, "ams", "rel", "", "\\@lvertneqq"),
        eg(ef, "ams", "rel", "⋦", "\\lnsim", !0),
        eg(ef, "ams", "rel", "⪉", "\\lnapprox", !0),
        eg(ef, "ams", "rel", "⊀", "\\nprec", !0),
        eg(ef, "ams", "rel", "⋠", "\\npreceq", !0),
        eg(ef, "ams", "rel", "⋨", "\\precnsim", !0),
        eg(ef, "ams", "rel", "⪹", "\\precnapprox", !0),
        eg(ef, "ams", "rel", "≁", "\\nsim", !0),
        eg(ef, "ams", "rel", "", "\\@nshortmid"),
        eg(ef, "ams", "rel", "∤", "\\nmid", !0),
        eg(ef, "ams", "rel", "⊬", "\\nvdash", !0),
        eg(ef, "ams", "rel", "⊭", "\\nvDash", !0),
        eg(ef, "ams", "rel", "⋪", "\\ntriangleleft"),
        eg(ef, "ams", "rel", "⋬", "\\ntrianglelefteq", !0),
        eg(ef, "ams", "rel", "⊊", "\\subsetneq", !0),
        eg(ef, "ams", "rel", "", "\\@varsubsetneq"),
        eg(ef, "ams", "rel", "⫋", "\\subsetneqq", !0),
        eg(ef, "ams", "rel", "", "\\@varsubsetneqq"),
        eg(ef, "ams", "rel", "≯", "\\ngtr", !0),
        eg(ef, "ams", "rel", "", "\\@ngeqslant"),
        eg(ef, "ams", "rel", "", "\\@ngeqq"),
        eg(ef, "ams", "rel", "⪈", "\\gneq", !0),
        eg(ef, "ams", "rel", "≩", "\\gneqq", !0),
        eg(ef, "ams", "rel", "", "\\@gvertneqq"),
        eg(ef, "ams", "rel", "⋧", "\\gnsim", !0),
        eg(ef, "ams", "rel", "⪊", "\\gnapprox", !0),
        eg(ef, "ams", "rel", "⊁", "\\nsucc", !0),
        eg(ef, "ams", "rel", "⋡", "\\nsucceq", !0),
        eg(ef, "ams", "rel", "⋩", "\\succnsim", !0),
        eg(ef, "ams", "rel", "⪺", "\\succnapprox", !0),
        eg(ef, "ams", "rel", "≆", "\\ncong", !0),
        eg(ef, "ams", "rel", "", "\\@nshortparallel"),
        eg(ef, "ams", "rel", "∦", "\\nparallel", !0),
        eg(ef, "ams", "rel", "⊯", "\\nVDash", !0),
        eg(ef, "ams", "rel", "⋫", "\\ntriangleright"),
        eg(ef, "ams", "rel", "⋭", "\\ntrianglerighteq", !0),
        eg(ef, "ams", "rel", "", "\\@nsupseteqq"),
        eg(ef, "ams", "rel", "⊋", "\\supsetneq", !0),
        eg(ef, "ams", "rel", "", "\\@varsupsetneq"),
        eg(ef, "ams", "rel", "⫌", "\\supsetneqq", !0),
        eg(ef, "ams", "rel", "", "\\@varsupsetneqq"),
        eg(ef, "ams", "rel", "⊮", "\\nVdash", !0),
        eg(ef, "ams", "rel", "⪵", "\\precneqq", !0),
        eg(ef, "ams", "rel", "⪶", "\\succneqq", !0),
        eg(ef, "ams", "rel", "", "\\@nsubseteqq"),
        eg(ef, "ams", "bin", "⊴", "\\unlhd"),
        eg(ef, "ams", "bin", "⊵", "\\unrhd"),
        eg(ef, "ams", "rel", "↚", "\\nleftarrow", !0),
        eg(ef, "ams", "rel", "↛", "\\nrightarrow", !0),
        ...
        eg(ef, "ams", "rel", "↮", "\\nleftrightarrow", !0),
        eg(ef, "ams", "rel", "⇎", "\\nLeftrightarrow", !0),
        eg(ef, "ams", "rel", "△", "\\vartriangle"),
        eg(ef, "ams", eT, "ℏ", "\\hslash"),
        eg(ef, "ams", eT, "▽", "\\triangledown"),
        eg(ef, "ams", eT, "◊", "\\lozenge"),
        eg(ef, "ams", eT, "Ⓢ", "\\circledS"),
        eg(ef, "ams", eT, "\xae", "\\circledR"),
        eg(ev, "ams", eT, "\xae", "\\circledR"),
        eg(ef, "ams", eT, "∡", "\\measuredangle", !0),
        eg(ef, "ams", eT, "∄", "\\nexists"),
        eg(ef, "ams", eT, "℧", "\\mho"),
        eg(ef, "ams", eT, "Ⅎ", "\\Finv", !0),
        eg(ef, "ams", eT, "⅁", "\\Game", !0),
        eg(ef, "ams", eT, "‵", "\\backprime"),
        eg(ef, "ams", eT, "▲", "\\blacktriangle"),
        eg(ef, "ams", eT, "▼", "\\blacktriangledown"),
        eg(ef, "ams", eT, "■", "\\blacksquare"),
        eg(ef, "ams", eT, "⧫", "\\blacklozenge"),
        eg(ef, "ams", eT, "★", "\\bigstar"),
        eg(ef, "ams", eT, "∢", "\\sphericalangle", !0),
        eg(ef, "ams", eT, "∁", "\\complement", !0),
        eg(ef, "ams", eT, "\xf0", "\\eth", !0),
        eg(ev, eb, eT, "\xf0", "\xf0"),
        eg(ef, "ams", eT, "╱", "\\diagup"),
        eg(ef, "ams", eT, "╲", "\\diagdown"),
        eg(ef, "ams", eT, "□", "\\square"),
        eg(ef, "ams", eT, "□", "\\Box"),
        eg(ef, "ams", eT, "◊", "\\Diamond"),
        eg(ef, "ams", eT, "\xa5", "\\yen", !0),
        eg(ev, "ams", eT, "\xa5", "\\yen", !0),
        eg(ef, "ams", eT, "✓", "\\checkmark", !0),
        eg(ev, "ams", eT, "✓", "\\checkmark"),
        eg(ef, "ams", eT, "ℶ", "\\beth", !0),
        eg(ef, "ams", eT, "ℸ", "\\daleth", !0),
        eg(ef, "ams", eT, "ℷ", "\\gimel", !0),
        eg(ef, "ams", eT, "ϝ", "\\digamma", !0),
        eg(ef, "ams", eT, "ϰ", "\\varkappa"),
        eg(ef, "ams", eM, "┌", "\\@ulcorner", !0),
        eg(ef, "ams", ex, "┐", "\\@urcorner", !0),
        eg(ef, "ams", eM, "└", "\\@llcorner", !0),
        eg(ef, "ams", ex, "┘", "\\@lrcorner", !0),
        eg(ef, "ams", "rel", "≦", "\\leqq", !0),
        eg(ef, "ams", "rel", "⩽", "\\leqslant", !0),
        eg(ef, "ams", "rel", "⪕", "\\eqslantless", !0),
        eg(ef, "ams", "rel", "≲", "\\lesssim", !0),
        eg(ef, "ams", "rel", "⪅", "\\lessapprox", !0),
        eg(ef, "ams", "rel", "≊", "\\approxeq", !0),
        eg(ef, "ams", "bin", "⋖", "\\lessdot"),
        eg(ef, "ams", "rel", "⋘", "\\lll", !0),
        eg(ef, "ams", "rel", "≶", "\\lessgtr", !0),
        eg(ef, "ams", "rel", "⋚", "\\lesseqgtr", !0),
        eg(ef, "ams", "rel", "⪋", "\\lesseqqgtr", !0),
        eg(ef, "ams", "rel", "≑", "\\doteqdot"),
        eg(ef, "ams", "rel", "≓", "\\risingdotseq", !0),
        eg(ef, "ams", "rel", "≒", "\\fallingdotseq", !0),
        eg(ef, "ams", "rel", "∽", "\\backsim", !0),
        eg(ef, "ams", "rel", "⋍", "\\backsimeq", !0),
        eg(ef, "ams", "rel", "⫅", "\\subseteqq", !0),
        eg(ef, "ams", "rel", "⋐", "\\Subset", !0),
        eg(ef, "ams", "rel", "⊏", "\\sqsubset", !0),
        eg(ef, "ams", "rel", "≼", "\\preccurlyeq", !0),
        eg(ef, "ams", "rel", "⋞", "\\curlyeqprec", !0),
        eg(ef, "ams", "rel", "≾", "\\precsim", !0),
        eg(ef, "ams", "rel", "⪷", "\\precapprox", !0),
        eg(ef, "ams", "rel", "⊲", "\\vartriangleleft"),
        eg(ef, "ams", "rel", "⊴", "\\trianglelefteq"),
        eg(ef, "ams", "rel", "⊨", "\\vDash", !0),
        eg(ef, "ams", "rel", "⊪", "\\Vvdash", !0),
        eg(ef, "ams", "rel", "⌣", "\\smallsmile"),
        eg(ef, "ams", "rel", "⌢", "\\smallfrown"),
        eg(ef, "ams", "rel", "≏", "\\bumpeq", !0),
        eg(ef, "ams", "rel", "≎", "\\Bumpeq", !0),
        eg(ef, "ams", "rel", "≧", "\\geqq", !0),
        eg(ef, "ams", "rel", "⩾", "\\geqslant", !0),
        eg(ef, "ams", "rel", "⪖", "\\eqslantgtr", !0),
        eg(ef, "ams", "rel", "≳", "\\gtrsim", !0),
        eg(ef, "ams", "rel", "⪆", "\\gtrapprox", !0),
        eg(ef, "ams", "bin", "⋗", "\\gtrdot"),
        eg(ef, "ams", "rel", "⋙", "\\ggg", !0),
        eg(ef, "ams", "rel", "≷", "\\gtrless", !0),
        eg(ef, "ams", "rel", "⋛", "\\gtreqless", !0),
        eg(ef, "ams", "rel", "⪌", "\\gtreqqless", !0),
        eg(ef, "ams", "rel", "≖", "\\eqcirc", !0),
        eg(ef, "ams", "rel", "≗", "\\circeq", !0),
        eg(ef, "ams", "rel", "≜", "\\triangleq", !0),
        eg(ef, "ams", "rel", "∼", "\\thicksim"),
        eg(ef, "ams", "rel", "≈", "\\thickapprox"),
        eg(ef, "ams", "rel", "⫆", "\\supseteqq", !0),
        eg(ef, "ams", "rel", "⋑", "\\Supset", !0),
        eg(ef, "ams", "rel", "⊐", "\\sqsupset", !0),
        eg(ef, "ams", "rel", "≽", "\\succcurlyeq", !0),
        eg(ef, "ams", "rel", "⋟", "\\curlyeqsucc", !0),
        eg(ef, "ams", "rel", "≿", "\\succsim", !0),
        eg(ef, "ams", "rel", "⪸", "\\succapprox", !0),
        eg(ef, "ams", "rel", "⊳", "\\vartriangleright"),
        eg(ef, "ams", "rel", "⊵", "\\trianglerighteq"),
        eg(ef, "ams", "rel", "⊩", "\\Vdash", !0),
        eg(ef, "ams", "rel", "∣", "\\shortmid"),
        eg(ef, "ams", "rel", "∥", "\\shortparallel"),
        eg(ef, "ams", "rel", "≬", "\\between", !0),
        eg(ef, "ams", "rel", "⋔", "\\pitchfork", !0),
        eg(ef, "ams", "rel", "∝", "\\varpropto"),
        eg(ef, "ams", "rel", "◀", "\\blacktriangleleft"),
        eg(ef, "ams", "rel", "∴", "\\therefore", !0),
        eg(ef, "ams", "rel", "∍", "\\backepsilon"),
        eg(ef, "ams", "rel", "▶", "\\blacktriangleright"),
        eg(ef, "ams", "rel", "∵", "\\because", !0),
        eg(ef, "ams", "rel", "⋘", "\\llless"),
        eg(ef, "ams", "rel", "⋙", "\\gggtr"),
        eg(ef, "ams", "bin", "⊲", "\\lhd"),
        eg(ef, "ams", "bin", "⊳", "\\rhd"),
        eg(ef, "ams", "rel", "≂", "\\eqsim", !0),
        eg(ef, eb, "rel", "⋈", "\\Join"),
        eg(ef, "ams", "rel", "≑", "\\Doteq", !0),
        eg(ef, "ams", "bin", "∔", "\\dotplus", !0),
        eg(ef, "ams", "bin", "∖", "\\smallsetminus"),
        eg(ef, "ams", "bin", "⋒", "\\Cap", !0),
        eg(ef, "ams", "bin", "⋓", "\\Cup", !0),
        eg(ef, "ams", "bin", "⩞", "\\doublebarwedge", !0),
        eg(ef, "ams", "bin", "⊟", "\\boxminus", !0),
        eg(ef, "ams", "bin", "⊞", "\\boxplus", !0),
        eg(ef, "ams", "bin", "⋇", "\\divideontimes", !0),
        eg(ef, "ams", "bin", "⋉", "\\ltimes", !0),
        eg(ef, "ams", "bin", "⋊", "\\rtimes", !0),
        eg(ef, "ams", "bin", "⋋", "\\leftthreetimes", !0),
        eg(ef, "ams", "bin", "⋌", "\\rightthreetimes", !0),
        eg(ef, "ams", "bin", "⋏", "\\curlywedge", !0),
        eg(ef, "ams", "bin", "⋎", "\\curlyvee", !0),
        eg(ef, "ams", "bin", "⊝", "\\circleddash", !0),
        eg(ef, "ams", "bin", "⊛", "\\circledast", !0),
        eg(ef, "ams", "bin", "⋅", "\\centerdot"),
        eg(ef, "ams", "bin", "⊺", "\\intercal", !0),
        eg(ef, "ams", "bin", "⋒", "\\doublecap"),
        eg(ef, "ams", "bin", "⋓", "\\doublecup"),
        eg(ef, "ams", "bin", "⊠", "\\boxtimes", !0),
        eg(ef, "ams", "rel", "⇢", "\\dashrightarrow", !0),
        eg(ef, "ams", "rel", "⇠", "\\dashleftarrow", !0),
        eg(ef, "ams", "rel", "⇇", "\\leftleftarrows", !0),
        eg(ef, "ams", "rel", "⇆", "\\leftrightarrows", !0),
        eg(ef, "ams", "rel", "⇚", "\\Lleftarrow", !0),
        eg(ef, "ams", "rel", "↞", "\\twoheadleftarrow", !0),
        eg(ef, "ams", "rel", "↢", "\\leftarrowtail", !0),
        eg(ef, "ams", "rel", "↫", "\\looparrowleft", !0),
        eg(ef, "ams", "rel", "⇋", "\\leftrightharpoons", !0),
        eg(ef, "ams", "rel", "↶", "\\curvearrowleft", !0),
        eg(ef, "ams", "rel", "↺", "\\circlearrowleft", !0),
        eg(ef, "ams", "rel", "↰", "\\Lsh", !0),
        eg(ef, "ams", "rel", "⇈", "\\upuparrows", !0),
        eg(ef, "ams", "rel", "↿", "\\upharpoonleft", !0),
        eg(ef, "ams", "rel", "⇃", "\\downharpoonleft", !0),
        eg(ef, eb, "rel", "⊶", "\\origof", !0),
        eg(ef, eb, "rel", "⊷", "\\imageof", !0),
        eg(ef, "ams", "rel", "⊸", "\\multimap", !0),
        eg(ef, "ams", "rel", "↭", "\\leftrightsquigarrow", !0),
        eg(ef, "ams", "rel", "⇉", "\\rightrightarrows", !0),
        eg(ef, "ams", "rel", "⇄", "\\rightleftarrows", !0),
        eg(ef, "ams", "rel", "↠", "\\twoheadrightarrow", !0),
        eg(ef, "ams", "rel", "↣", "\\rightarrowtail", !0),
        eg(ef, "ams", "rel", "↬", "\\looparrowright", !0),
        eg(ef, "ams", "rel", "↷", "\\curvearrowright", !0),
        eg(ef, "ams", "rel", "↻", "\\circlearrowright", !0),
        eg(ef, "ams", "rel", "↱", "\\Rsh", !0),
        eg(ef, "ams", "rel", "⇊", "\\downdownarrows", !0),
        eg(ef, "ams", "rel", "↾", "\\upharpoonright", !0),
        eg(ef, "ams", "rel", "⇂", "\\downharpoonright", !0),
        eg(ef, "ams", "rel", "⇝", "\\rightsquigarrow", !0),
        eg(ef, "ams", "rel", "⇝", "\\leadsto"),
        eg(ef, "ams", "rel", "⇛", "\\Rrightarrow", !0),
        eg(ef, "ams", "rel", "↾", "\\restriction"),
        eg(ef, eb, eT, "‘", "`"),
        eg(ef, eb, eT, "$", "\\$"),
        eg(ev, eb, eT, "$", "\\$"),
        eg(ev, eb, eT, "$", "\\textdollar"),
        eg(ef, eb, eT, "%", "\\%"),
        eg(ev, eb, eT, "%", "\\%"),
        eg(ef, eb, eT, "_", "\\_"),
        eg(ev, eb, eT, "_", "\\_"),
        eg(ev, eb, eT, "_", "\\textunderscore"),
        eg(ef, eb, eT, "∠", "\\angle", !0),
        eg(ef, eb, eT, "∞", "\\infty", !0),
        eg(ef, eb, eT, "′", "\\prime"),
        eg(ef, eb, eT, "△", "\\triangle"),
        eg(ef, eb, eT, "Γ", "\\Gamma", !0),
        eg(ef, eb, eT, "Δ", "\\Delta", !0),
        eg(ef, eb, eT, "Θ", "\\Theta", !0),
        eg(ef, eb, eT, "Λ", "\\Lambda", !0),
        eg(ef, eb, eT, "Ξ", "\\Xi", !0),
        eg(ef, eb, eT, "Π", "\\Pi", !0),
        eg(ef, eb, eT, "Σ", "\\Sigma", !0),
        eg(ef, eb, eT, "Υ", "\\Upsilon", !0),
        eg(ef, eb, eT, "Φ", "\\Phi", !0),
        eg(ef, eb, eT, "Ψ", "\\Psi", !0),
        eg(ef, eb, eT, "Ω", "\\Omega", !0),
        eg(ef, eb, eT, "A", "Α"),
        eg(ef, eb, eT, "B", "Β"),
        eg(ef, eb, eT, "E", "Ε"),
        eg(ef, eb, eT, "Z", "Ζ"),
        ...
        eg(ef, eb, eT, "X", "Χ"),
        eg(ef, eb, eT, "\xac", "\\neg", !0),
        eg(ef, eb, eT, "\xac", "\\lnot"),
        eg(ef, eb, eT, "⊤", "\\top"),
        eg(ef, eb, eT, "⊥", "\\bot"),
        eg(ef, eb, eT, "∅", "\\emptyset"),
        eg(ef, "ams", eT, "∅", "\\varnothing"),
        eg(ef, eb, ek, "α", "\\alpha", !0),
        eg(ef, eb, ek, "β", "\\beta", !0),
        eg(ef, eb, ek, "γ", "\\gamma", !0),
        eg(ef, eb, ek, "δ", "\\delta", !0),
        eg(ef, eb, ek, "ϵ", "\\epsilon", !0),
        eg(ef, eb, ek, "ζ", "\\zeta", !0),
        eg(ef, eb, ek, "η", "\\eta", !0),
        eg(ef, eb, ek, "θ", "\\theta", !0),
        eg(ef, eb, ek, "ι", "\\iota", !0),
        eg(ef, eb, ek, "κ", "\\kappa", !0),
        eg(ef, eb, ek, "λ", "\\lambda", !0),
        eg(ef, eb, ek, "μ", "\\mu", !0),
        eg(ef, eb, ek, "ν", "\\nu", !0),
        eg(ef, eb, ek, "ξ", "\\xi", !0),
        eg(ef, eb, ek, "ο", "\\omicron", !0),
        eg(ef, eb, ek, "π", "\\pi", !0),
        eg(ef, eb, ek, "ρ", "\\rho", !0),
        eg(ef, eb, ek, "σ", "\\sigma", !0),
        eg(ef, eb, ek, "τ", "\\tau", !0),
        eg(ef, eb, ek, "υ", "\\upsilon", !0),
        eg(ef, eb, ek, "ϕ", "\\phi", !0),
        eg(ef, eb, ek, "χ", "\\chi", !0),
        eg(ef, eb, ek, "ψ", "\\psi", !0),
        eg(ef, eb, ek, "ω", "\\omega", !0),
        eg(ef, eb, ek, "ε", "\\varepsilon", !0),
        eg(ef, eb, ek, "ϑ", "\\vartheta", !0),
        eg(ef, eb, ek, "ϖ", "\\varpi", !0),
        eg(ef, eb, ek, "ϱ", "\\varrho", !0),
        eg(ef, eb, ek, "ς", "\\varsigma", !0),
        eg(ef, eb, ek, "φ", "\\varphi", !0),
        eg(ef, eb, "bin", "∗", "*", !0),
        eg(ef, eb, "bin", "+", "+"),
        eg(ef, eb, "bin", "−", "-", !0),
        eg(ef, eb, "bin", "⋅", "\\cdot", !0),
        eg(ef, eb, "bin", "∘", "\\circ", !0),
        eg(ef, eb, "bin", "\xf7", "\\div", !0),
        eg(ef, eb, "bin", "\xb1", "\\pm", !0),
        eg(ef, eb, "bin", "\xd7", "\\times", !0),
        eg(ef, eb, "bin", "∩", "\\cap", !0),
        eg(ef, eb, "bin", "∪", "\\cup", !0),
        eg(ef, eb, "bin", "∖", "\\setminus", !0),
        eg(ef, eb, "bin", "∧", "\\land"),
        eg(ef, eb, "bin", "∨", "\\lor"),
        eg(ef, eb, "bin", "∧", "\\wedge", !0),
        eg(ef, eb, "bin", "∨", "\\vee", !0),
        eg(ef, eb, eT, "√", "\\surd"),
        eg(ef, eb, eM, "⟨", "\\langle", !0),
        eg(ef, eb, eM, "∣", "\\lvert"),
        eg(ef, eb, eM, "∥", "\\lVert"),
        eg(ef, eb, ex, "?", "?"),
        eg(ef, eb, ex, "!", "!"),
        eg(ef, eb, ex, "⟩", "\\rangle", !0),
        eg(ef, eb, ex, "∣", "\\rvert"),
        eg(ef, eb, ex, "∥", "\\rVert"),
        eg(ef, eb, "rel", "=", "="),
        eg(ef, eb, "rel", ":", ":"),
        eg(ef, eb, "rel", "≈", "\\approx", !0),
        eg(ef, eb, "rel", "≅", "\\cong", !0),
        eg(ef, eb, "rel", "≥", "\\ge"),
        eg(ef, eb, "rel", "≥", "\\geq", !0),
        eg(ef, eb, "rel", "←", "\\gets"),
        ...
        eg(ef, eb, "rel", "∈", "\\in", !0),
        eg(ef, eb, "rel", "", "\\@not"),
        eg(ef, eb, "rel", "⊂", "\\subset", !0),
        eg(ef, eb, "rel", "⊃", "\\supset", !0),
        eg(ef, eb, "rel", "⊆", "\\subseteq", !0),
        eg(ef, eb, "rel", "⊇", "\\supseteq", !0),
        eg(ef, "ams", "rel", "⊈", "\\nsubseteq", !0),
        eg(ef, "ams", "rel", "⊉", "\\nsupseteq", !0),
        eg(ef, eb, "rel", "⊨", "\\models"),
        eg(ef, eb, "rel", "←", "\\leftarrow", !0),
        ...
        eg(ef, "ams", "rel", "≰", "\\nleq", !0),
        eg(ef, eb, eA, "\xa0", "\\ "),
        eg(ef, eb, eA, "\xa0", "\\space"),
        eg(ef, eb, eA, "\xa0", "\\nobreakspace"),
        eg(ev, eb, eA, "\xa0", "\\ "),
        eg(ev, eb, eA, "\xa0", " "),
        eg(ev, eb, eA, "\xa0", "\\space"),
        eg(ev, eb, eA, "\xa0", "\\nobreakspace"),
        eg(ef, eb, eA, null, "\\nobreak"),
        eg(ef, eb, eA, null, "\\allowbreak"),
        eg(ef, eb, ez, ",", ","),
        eg(ef, eb, ez, ";", ";"),
        eg(ef, "ams", "bin", "⊼", "\\barwedge", !0),
        eg(ef, "ams", "bin", "⊻", "\\veebar", !0),
        eg(ef, eb, "bin", "⊙", "\\odot", !0),
        eg(ef, eb, "bin", "⊕", "\\oplus", !0),
        eg(ef, eb, "bin", "⊗", "\\otimes", !0),
        eg(ef, eb, eT, "∂", "\\partial", !0),
        eg(ef, eb, "bin", "⊘", "\\oslash", !0),
        eg(ef, "ams", "bin", "⊚", "\\circledcirc", !0),
        eg(ef, "ams", "bin", "⊡", "\\boxdot", !0),
        eg(ef, eb, "bin", "△", "\\bigtriangleup"),
        eg(ef, eb, "bin", "▽", "\\bigtriangledown"),
        eg(ef, eb, "bin", "†", "\\dagger"),
        eg(ef, eb, "bin", "⋄", "\\diamond"),
        eg(ef, eb, "bin", "⋆", "\\star"),
        eg(ef, eb, "bin", "◃", "\\triangleleft"),
        eg(ef, eb, "bin", "▹", "\\triangleright"),
        eg(ef, eb, eM, "{", "\\{"),
        eg(ev, eb, eT, "{", "\\{"),
        eg(ev, eb, eT, "{", "\\textbraceleft"),
        eg(ef, eb, ex, "}", "\\}"),
        eg(ev, eb, eT, "}", "\\}"),
        eg(ev, eb, eT, "}", "\\textbraceright"),
        eg(ef, eb, eM, "{", "\\lbrace"),
        eg(ef, eb, ex, "}", "\\rbrace"),
        eg(ef, eb, eM, "[", "\\lbrack", !0),
        eg(ev, eb, eT, "[", "\\lbrack", !0),
        eg(ef, eb, ex, "]", "\\rbrack", !0),
        eg(ev, eb, eT, "]", "\\rbrack", !0),
        eg(ef, eb, eM, "(", "\\lparen", !0),
        eg(ef, eb, ex, ")", "\\rparen", !0),
        eg(ev, eb, eT, "<", "\\textless", !0),
        eg(ev, eb, eT, ">", "\\textgreater", !0),
        eg(ef, eb, eM, "⌊", "\\lfloor", !0),
        eg(ef, eb, ex, "⌋", "\\rfloor", !0),
        eg(ef, eb, eM, "⌈", "\\lceil", !0),
        eg(ef, eb, ex, "⌉", "\\rceil", !0),
        eg(ef, eb, eT, "\\", "\\backslash"),
        eg(ef, eb, eT, "∣", "|"),
        eg(ef, eb, eT, "∣", "\\vert"),
        eg(ev, eb, eT, "|", "\\textbar", !0),
        eg(ef, eb, eT, "∥", "\\|"),
        eg(ef, eb, eT, "∥", "\\Vert"),
        eg(ev, eb, eT, "∥", "\\textbardbl"),
        eg(ev, eb, eT, "~", "\\textasciitilde"),
        eg(ev, eb, eT, "\\", "\\textbackslash"),
        eg(ev, eb, eT, "^", "\\textasciicircum"),
        eg(ef, eb, "rel", "↑", "\\uparrow", !0),
        eg(ef, eb, "rel", "⇑", "\\Uparrow", !0),
        eg(ef, eb, "rel", "↓", "\\downarrow", !0),
        eg(ef, eb, "rel", "⇓", "\\Downarrow", !0),
        eg(ef, eb, "rel", "↕", "\\updownarrow", !0),
        eg(ef, eb, "rel", "⇕", "\\Updownarrow", !0),
        eg(ef, eb, eS, "∐", "\\coprod"),
        eg(ef, eb, eS, "⋁", "\\bigvee"),
        eg(ef, eb, eS, "⋀", "\\bigwedge"),
        eg(ef, eb, eS, "⨄", "\\biguplus"),
        eg(ef, eb, eS, "⋂", "\\bigcap"),
        eg(ef, eb, eS, "⋃", "\\bigcup"),
        eg(ef, eb, eS, "∫", "\\int"),
        eg(ef, eb, eS, "∫", "\\intop"),
        ...
        eg(ef, eb, eS, "∏", "\\prod"),
        eg(ef, eb, eS, "∑", "\\sum"),
        eg(ef, eb, eS, "⨂", "\\bigotimes"),
        eg(ef, eb, eS, "⨁", "\\bigoplus"),
        eg(ef, eb, eS, "⨀", "\\bigodot"),
        eg(ef, eb, eS, "∮", "\\oint"),
        eg(ef, eb, eS, "∯", "\\oiint"),
        eg(ef, eb, eS, "∰", "\\oiiint"),
        eg(ef, eb, eS, "⨆", "\\bigsqcup"),
        eg(ef, eb, eS, "∫", "\\smallint"),
        eg(ev, eb, ew, "…", "\\textellipsis"),
        eg(ef, eb, ew, "…", "\\mathellipsis"),
        eg(ev, eb, ew, "…", "\\ldots", !0),
        eg(ef, eb, ew, "…", "\\ldots", !0),
        eg(ef, eb, ew, "⋯", "\\@cdots", !0),
        eg(ef, eb, ew, "⋱", "\\ddots", !0),
        eg(ef, eb, eT, "⋮", "\\varvdots"),
        eg(ef, eb, ey, "ˊ", "\\acute"),
        eg(ef, eb, ey, "ˋ", "\\grave"),
        eg(ef, eb, ey, "\xa8", "\\ddot"),
        eg(ef, eb, ey, "~", "\\tilde"),
        eg(ef, eb, ey, "ˉ", "\\bar"),
        eg(ef, eb, ey, "˘", "\\breve"),
        eg(ef, eb, ey, "ˇ", "\\check"),
        ...
        eg(ev, eb, eT, "ı", "\\i", !0),
        eg(ev, eb, eT, "ȷ", "\\j", !0),
        eg(ev, eb, eT, "\xdf", "\\ss", !0),
        eg(ev, eb, eT, "\xe6", "\\ae", !0),
        eg(ev, eb, eT, "œ", "\\oe", !0),
        eg(ev, eb, eT, "\xf8", "\\o", !0),
        eg(ev, eb, eT, "\xc6", "\\AE", !0),
        eg(ev, eb, eT, "Œ", "\\OE", !0),
        eg(ev, eb, eT, "\xd8", "\\O", !0),
        eg(ev, eb, ey, "ˊ", "\\'"),
        eg(ev, eb, ey, "ˋ", "\\`"),
        ...
        eg(ev, eb, ey, "\xa8", '\\"'),
        eg(ev, eb, ey, "˝", "\\H"),
        eg(ev, eb, ey, "◯", "\\textcircled");
      var eB = { "--": !0, "---": !0, "``": !0, "''": !0 };
      eg(ev, eb, eT, "–", "--", !0),
        eg(ev, eb, eT, "–", "\\textendash"),
        eg(ev, eb, eT, "—", "---", !0),
        eg(ev, eb, eT, "—", "\\textemdash"),
        eg(ev, eb, eT, "‘", "`", !0),
        eg(ev, eb, eT, "‘", "\\textquoteleft"),
        eg(ev, eb, eT, "’", "'", !0),
        eg(ev, eb, eT, "’", "\\textquoteright"),
        eg(ev, eb, eT, "“", "``", !0),
        eg(ev, eb, eT, "“", "\\textquotedblleft"),
        eg(ev, eb, eT, "”", "''", !0),
        eg(ev, eb, eT, "”", "\\textquotedblright"),
        eg(ef, eb, eT, "\xb0", "\\degree", !0),
        eg(ev, eb, eT, "\xb0", "\\degree"),
        eg(ev, eb, eT, "\xb0", "\\textdegree", !0),
        eg(ef, eb, eT, "\xa3", "\\pounds"),
        eg(ef, eb, eT, "\xa3", "\\mathsterling", !0),
        eg(ev, eb, eT, "\xa3", "\\pounds"),
        eg(ev, eb, eT, "\xa3", "\\textsterling", !0),
        eg(ef, "ams", eT, "✠", "\\maltese"),
        eg(ev, "ams", eT, "✠", "\\maltese");
      for (var eC = '0123456789/@."', eq = 0; eq < eC.length; eq++) {
        var eN = eC.charAt(eq);
        eg(ef, eb, eT, eN, eN);
      }
      for (var eI = '0123456789!@*()-=+";:?/.,', eR = 0; eR < eI.length; eR++) {
        var eO = eI.charAt(eR);
        eg(ev, eb, eT, eO, eO);
      }
      for (
        var eH = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", eE = 0;
        eE < eH.length;
        eE++
      ) {
        var eL = eH.charAt(eE);
        eg(ef, eb, ek, eL, eL), eg(ev, eb, eT, eL, eL);
      }
      eg(ef, "ams", eT, "C", "ℂ"),
        eg(ev, "ams", eT, "C", "ℂ"),
        eg(ef, "ams", eT, "H", "ℍ"),
        ...
        eg(ef, eb, ek, "h", "ℎ"),
        eg(ev, eb, ek, "h", "ℎ");
      for (var eD = "", eP = 0; eP < eH.length; eP++) {
        var eF = eH.charAt(eP);
        eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56320 + eP))),
          eg(ev, eb, eT, eF, eD),
          eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56372 + eP))),
          eg(ev, eb, eT, eF, eD),
          eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56424 + eP))),
          eg(ev, eb, eT, eF, eD),
          eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56580 + eP))),
          eg(ev, eb, eT, eF, eD),
          eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56736 + eP))),
          eg(ev, eb, eT, eF, eD),
          eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56788 + eP))),
          eg(ev, eb, eT, eF, eD),
          eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56840 + eP))),
          eg(ev, eb, eT, eF, eD),
          eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56944 + eP))),
          eg(ev, eb, eT, eF, eD),
          eP < 26 &&
            (eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56632 + eP))),
            eg(ev, eb, eT, eF, eD),
            eg(ef, eb, ek, eF, (eD = String.fromCharCode(55349, 56476 + eP))),
            eg(ev, eb, eT, eF, eD));
      }
      eg(ef, eb, ek, "k", (eD = String.fromCharCode(55349, 56668))),
        eg(ev, eb, eT, "k", eD);
      for (var eV = 0; eV < 10; eV++) {
        var eG = eV.toString();
        eg(ef, eb, ek, eG, (eD = String.fromCharCode(55349, 57294 + eV))),
          eg(ev, eb, eT, eG, eD),
          eg(ef, eb, ek, eG, (eD = String.fromCharCode(55349, 57314 + eV))),
          eg(ev, eb, eT, eG, eD),
          eg(ef, eb, ek, eG, (eD = String.fromCharCode(55349, 57324 + eV))),
          eg(ev, eb, eT, eG, eD),
          eg(ef, eb, ek, eG, (eD = String.fromCharCode(55349, 57334 + eV))),
          eg(ev, eb, eT, eG, eD);
      }
      for (var eU = "\xd0\xde\xfe", eY = 0; eY < eU.length; eY++) {
        var eX = eU.charAt(eY);
        eg(ef, eb, ek, eX, eX), eg(ev, eb, eT, eX, eX);
      }
      var eW = [
        ...
        ej = function (e, t) {
          ...
          if (119808 <= r && r < 120484) {
            ...
            return [eW[n][2], eW[n][a]];
          }
          if (120782 <= r && r <= 120831) {
            var s = Math.floor((r - 120782) / 10);
            return [e_[s][2], e_[s][a]];
          }
          if (120485 === r || 120486 === r) return [eW[0][2], eW[0][a]];
          if (120486 < r && r < 120782) return ["", ""];
          throw new i("Unsupported character: " + e);
        },
        e$ = function (e, t, r) {
          return (
            ed[r][e] && ed[r][e].replace && (e = ed[r][e].replace),
            { value: e, metrics: G(e, t, r) }
          );
        },
        eZ = function (e, t, r, a, n) {
          var i,
            s = e$(e, t, r),
            o = s.metrics;
          if (((e = s.value), o)) {
            ...
            ("text" === r || (a && "mathit" === a.font)) && (l = 0),
              (i = new eo(e, o.height, o.depth, l, o.skew, o.width, n));
          } else
            "undefined" != typeof console &&
              console.warn(
        ...
        eQ = function (e, t, r, a) {
          var n = new ea(e, t, r, a);
          return eJ(n), n;
        },
        e0 = (e, t, r, a) => new ea(e, t, r, a),
        e1 = function (e) {
          var t = new D(e);
          return eJ(t), t;
        },
          ...
          if ("individualShift" === e.positionType) {
            for (
              var t,
                r = e.children,
                a = [r[0]],
                n = -r[0].shift - r[0].elem.depth,
                i = n,
                s = 1;
              s < r.length;
              s++
            ) {
              var o = -r[s].shift - i - r[s].elem.depth,
                l = o - (r[s - 1].elem.height + r[s - 1].elem.depth);
              (i += o), a.push({ type: "kern", size: l }), a.push(r[s]);
            }
        ...
        e5 = (e, t) => {
          var r = eQ(["mspace"], [], t),
            a = K(e, t);
          return (r.style.marginRight = J(a)), r;
        },
        e6 = function (e, t, r) {
          var a = "";
          switch (e) {
        ...
        e8 = {
          ...
          makeAnchor: function (e, t, r, a) {
            var n = new en(e, t, r, a);
            return eJ(n), n;
          },
          makeFragment: e1,
          wrapFragment: function (e, t) {
            return e instanceof D ? eQ([], [e], t) : e;
          },
          makeVList: function (e, t) {
            for (
              var r, { children: a, depth: n } = e4(e), i = 0, s = 0;
              s < a.length;
              s++
            ) {
              var o = a[s];
            ...
            for (var m = [], c = n, p = n, u = n, d = 0; d < a.length; d++) {
              ...
              if ("kern" === g.type) u += g.size;
                ...
                (v.style.top = J(-i - u - f.depth)),
                  ...
                  g.marginRight && (v.style.marginRight = g.marginRight),
                  m.push(v),
                  (u += f.height + f.depth);
              }
            ...
            var b = eQ(["vlist"], m);
            if (((b.style.height = J(p)), c < 0)) {
              var y = eQ([], []),
                x = eQ(["vlist"], [y]);
              x.style.height = J(-c);
              var w = eQ(["vlist-s"], [new eo("​")]);
              r = [eQ(["vlist-r"], [b, w]), eQ(["vlist-r"], [x])];
            } else r = [eQ(["vlist-r"], [b])];
            var k = eQ(["vlist-t"], r);
            return (
              2 === r.length && k.classes.push("vlist-t2"),
              (k.height = p),
              (k.depth = -c),
              k
            );
          ...
          makeOrd: function (e, t, r) {
            var a = e.mode,
              ...
              o = s ? t.font : t.fontFamily;
            if (55349 === n.charCodeAt(0)) {
              var [l, h] = ej(n, a);
              return eZ(n, l, a, t, i.concat(h));
            }
            if (o) {
              if ("boldsymbol" === o) {
                var m,
                  c,
                  p =
                    "textord" !== r && e$(n, "Math-BoldItalic", a).metrics
                ...
                s
                  ? ((m = e7[o].fontName), (c = [o]))
                  : ((m = e6(o, t.fontWeight, t.fontShape)),
                    (c = [o, t.fontWeight, t.fontShape]));
              if (e$(n, m, a).metrics) return eZ(n, m, a, t, i.concat(c));
              if (eB.hasOwnProperty(n) && "Typewriter" === m.substr(0, 10)) {
                for (var u = [], d = 0; d < n.length; d++)
                  u.push(eZ(n[d], m, a, t, i.concat(c)));
                return e1(u);
              }
            }
            if ("mathord" === r)
              return eZ(n, "Math-Italic", a, t, i.concat(["mathnormal"]));
            if ("textord" === r) {
              var g = ed[a][n] && ed[a][n].font;
              if ("ams" === g)
                return eZ(
                  n,
        ...
        te = { number: 5, unit: "mu" },
        tt = {
          mord: { mop: e2, mbin: e9, mrel: te, minner: e2 },
          mop: { mord: e2, mop: e2, mrel: te, minner: e2 },
          mbin: { mord: e9, mop: e9, mopen: e9, minner: e9 },
          mrel: { mord: te, mop: te, mopen: te, minner: te },
          mopen: {},
          mclose: { mop: e2, mbin: e9, mrel: te, minner: e2 },
          mpunct: {
            mord: e2,
            mop: e2,
            mrel: te,
      ...
      var tl = function (e) {
        ...
        tp = ["rightmost", "mrel", "mclose", "mpunct"],
        tu = {
          display: N.DISPLAY,
          text: N.TEXT,
          script: N.SCRIPT,
        ...
        tg = function (e, t, r, a) {
          ...
          if ((e8.tryCombineChars(n), !r)) return n;
          var l = t;
          if (1 === e.length) {
            var h = e[0];
            "sizing" === h.type
              ? (l = t.havingSize(h.size))
              : "styling" === h.type && (l = t.havingStyle(tu[h.style]));
          }
          var m = tm([a[0] || "leftmost"], [], t),
            c = tm([a[1] || "rightmost"], [], t),
            p = "root" === r;
          return (
            tf(
              n,
        ...
        tf = function e(t, r, a, n, i) {
          ...
          for (var s = 0; s < t.length; s++) {
            var o,
              ...
              h = tv(l);
            if (h) {
              e(h.children, r, a, null, i);
              continue;
            }
            var m = !l.hasClass("mspace");
            if (m) {
              var c = r(l, a.node);
              c && (a.insertAfter ? a.insertAfter(c) : (t.unshift(c), s++));
            }
            m
              ? (a.node = l)
              : i && l.hasClass("newline") && (a.node = tm(["leftmost"])),
              (a.insertAfter =
                ((o = s),
                (e) => {
                  t.splice(o + 1, 0, e), s++;
        ...
        tv = function (e) {
          return e instanceof D ||
            e instanceof en ||
            (e instanceof ea && e.hasClass("enclosing"))
            ? e
            : null;
        },
        tb = function e(t, r) {
        ...
        ty = function (e, t) {
          return e ? (t && (e = tb(e, t)), td[e.classes[0]] || null) : null;
        },
        tx = function (e, t) {
          var r = ["nulldelimiter"].concat(e.baseSizingClasses());
          return tm(t.concat(r));
        },
        tw = function (e, t, r) {
          if (!e) return tm();
          if (tn[e.type]) {
      ...
      function tk(e, t) {
        var r = tm(["base"], e, t),
          a = tm(["strut"]);
        return (
          (a.style.height = J(r.height + r.depth)),
          r.depth && (a.style.verticalAlign = J(-r.depth)),
      ...
      function tS(e, t) {
        ...
        for (var s = [], o = [], l = 0; l < i.length; l++)
          if (
            ...
            i[l].hasClass("newline") &&
              (o.pop(),
              o.length > 0 && (s.push(tk(o, t)), (o = [])),
              s.push(i[l]));
        o.length > 0 && s.push(tk(o, t)),
          n
            ? (((a = tk(tg(n, t, !0))).classes = ["tag"]), s.push(a))
            : r && s.push(r);
        var m = tm(["katex-html"], s);
        if ((m.setAttribute("aria-hidden", "true"), a)) {
          var c = a.children[0];
          (c.style.height = J(m.height + m.depth)),
            m.depth && (c.style.verticalAlign = J(-m.depth));
        }
        return m;
      }
      function tM(e) {
      ...
      class tz {
        ...
        toNode() {
          ...
          for (var t in this.attributes)
            Object.prototype.hasOwnProperty.call(this.attributes, t) &&
              e.setAttribute(t, this.attributes[t]);
          this.classes.length > 0 && (e.className = Q(this.classes));
          for (var r = 0; r < this.children.length; r++)
            e.appendChild(this.children[r].toNode());
          return e;
        }
        toMarkup() {
          ...
          for (var t in this.attributes)
            Object.prototype.hasOwnProperty.call(this.attributes, t) &&
              (e += " " + t + '="' + x.escape(this.attributes[t]) + '"');
          this.classes.length > 0 &&
            (e += ' class ="' + x.escape(Q(this.classes)) + '"'),
            (e += ">");
          for (var r = 0; r < this.children.length; r++)
            e += this.children[r].toMarkup();
          return e + ("</" + this.type) + ">";
      ...
      var tT = {
          ...
          SpaceNode: class {
            ...
            toMarkup() {
              return this.character
                ...
                : '<mspace width="' + J(this.width) + '"/>';
            }
            toText() {
              return this.character ? this.character : " ";
            }
          },
          newDocumentFragment: tM,
        },
        tB = function (e, t, r) {
          return (
            ed[t][e] &&
        ...
        tq = function (e, t) {
          ...
          else if ("mathtt" === r) return "monospace";
          var n = e.text;
        ...
        tN = function (e, t, r) {
          ...
          for (var i = [], s = 0; s < e.length; s++) {
            var o = tR(e[s], t);
            if (o instanceof tz && a instanceof tz) {
              if (
                ("mtext" === o.type &&
                  "mtext" === a.type &&
        ...
        tR = function (e, t) {
          ...
          if (ti[e.type]) return ti[e.type](e, t);
          throw new i("Got group of unknown type: '" + e.type + "'");
        };
      function tO(e, t, r, a, n) {
        var i,
          s = tN(e, r);
        i =
          1 === s.length &&
          s[0] instanceof tz &&
          x.contains(["mrow", "mtable"], s[0].type)
            ? s[0]
            : new tT.MathNode("mrow", s);
        var o = new tT.MathNode("annotation", [new tT.TextNode(t)]);
        o.setAttribute("encoding", "application/x-tex");
        var l = new tT.MathNode("semantics", [i, o]),
          h = new tT.MathNode("math", [l]);
        return (
          h.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"),
          a && h.setAttribute("display", "block"),
          e8.makeSpan([n ? "katex" : "katex-mathml"], [h])
        );
      }
      var tH = function (e) {
          return new _({
        ...
        tL = function (e, t, r) {
          var a,
            n = tH(r);
          if ("mathml" === r.output) return tO(e, t, n, r.displayMode, !0);
          if ("html" === r.output) {
            var i = tS(e, n);
            a = e8.makeSpan(["katex"], [i]);
          } else {
            var s = tO(e, t, n, r.displayMode, !1),
              o = tS(e, n);
            a = e8.makeSpan(["katex"], [s, o]);
          }
          return tE(a, r);
        },
        tD = function (e, t, r) {
          var a = tS(e, tH(r));
          return tE(e8.makeSpan(["katex"], [a]), r);
        },
        tP = {
          widehat: "^",
          widecheck: "ˇ",
        ...
        tV = {
          encloseSpan: function (e, t, r, a, n) {
            var i,
              s = e.height + e.depth + r + a;
            if (/fbox|color|angl/.test(t)) {
              if (((i = e8.makeSpan(["stretchy", t], [], n)), "fbox" === t)) {
            ...
            return (i.height = s), (i.style.height = J(s)), i;
          },
          mathMLnode: function (e) {
            var t = new tT.MathNode("mo", [
              new tT.TextNode(tP[e.replace(/^\\/, "")]),
            ]);
          ...
          svgSpan: function (e, t) {
            var {
              ...
              var r = 4e5,
                a = e.label.substr(1);
              if (
                x.contains(["widehat", "widecheck", "widetilde", "utilde"], a)
              ) {
                var n,
                  i,
                  s,
                  o,
                  l = "ordgroup" === (o = e.base).type ? o.body.length : 1;
                if (l > 5)
                  "widehat" === a || "widecheck" === a
                    ? ((n = 420), (r = 2364), (s = 0.42), (i = a + "4"))
                    : ((n = 312), (r = 2340), (s = 0.34), (i = "tilde4"));
                else {
                  var h = [1, 1, 2, 2, 3, 3][l];
                  "widehat" === a || "widecheck" === a
                    ? ((r = [0, 1062, 2364, 2364, 2364][h]),
                      (n = [0, 239, 300, 360, 420][h]),
                      (s = [0, 0.24, 0.3, 0.3, 0.36, 0.42][h]),
                      (i = a + h))
                    : ((r = [0, 600, 1033, 2339, 2340][h]),
                      (n = [0, 260, 286, 306, 312][h]),
                      (s = [0, 0.26, 0.286, 0.3, 0.306, 0.34][h]),
                      (i = "tilde" + h));
                }
                var m = new eh(i),
                  c = new el([m], {
              ...
              for (var k = 0; k < w; k++) {
                var S = new eh(f[k]),
                  ...
                  z = e8.makeSvgSpan([p[k]], [M], t);
                if (1 === w) return { span: z, minWidth: v, height: y };
                (z.style.height = J(y)), d.push(z);
              }
              return {
                span: e8.makeSpan(["stretchy"], d, t),
                minWidth: v,
                height: y,
              };
            })();
      ...
      var tX = (e, t) => {
          e && "supsub" === e.type
            ? ((o = (l = tG(e.base, "accent")).base),
              ...
              (e.base = l))
            : (o = (l = tG(e, "accent")).base);
          var r = tw(o, t.havingCrampedStyle()),
            a = l.isShifty && x.isCharacterBox(o),
            n = 0;
          a && (n = ec(tw(x.getBaseElem(o), t.havingCrampedStyle())).skew);
          var i = "\\c" === l.label,
            s = i
              ? r.height + r.depth
              : Math.min(r.height, t.fontMetrics().xHeight);
          if (l.isStretchy)
            (m = tV.svgSpan(l, t)),
              (m = e8.makeVList(
                {
            ...
            "\\vec" === l.label
              ? ((c = e8.staticSvg("vec", t)), (p = e8.svgData.vec[1]))
              : (((c = ec(
                  (c = e8.makeOrd(
            ...
            var o,
              ...
              c,
              p,
              u = "\\textcircled" === l.label;
            u && (m.classes.push("accent-full"), (s = r.height));
            var d = n;
            u || (d -= p / 2),
              (m.style.left = J(d)),
              "\\textcircled" === l.label && (m.style.top = ".2em"),
              (m = e8.makeVList(
                {
                  positionType: "firstBaseline",
                  children: [
          ...
          return h
            ? ((h.children[0] = g),
              (h.height = Math.max(g.height, h.height)),
              (h.classes[0] = "mord"),
              h)
            : g;
        },
        tW = (e, t) => {
          var r = e.isStretchy
              ? tV.mathMLnode(e.label)
              : new tT.MathNode("mo", [tB(e.label, e.mode)]),
            a = new tT.MathNode("mover", [tR(e.base, t), r]);
      ...
      ts({
        ...
        ts({
          ...
          mathmlBuilder: (e, t) => {
            var r = tV.mathMLnode(e.label),
              a = new tT.MathNode("munder", [tR(e.base, t), r]);
      ...
      ts({
        ...
        htmlBuilder(e, t) {
          var r,
            ...
            s = e8.wrapFragment(tw(e.body, i, t), t),
          ...
          if (
            ((s.depth > 0.25 || "\\xleftequilibrium" === e.label) &&
              (m -= s.depth),
            r)
          ) {
            var c =
              -t.fontMetrics().axisHeight + r.height + 0.5 * l.height + 0.111;
            a = e8.makeVList(
              {
          ...
          return (
            ...
            e8.makeSpan(["mrel", "x-arrow"], [a], t)
          );
        },
        mathmlBuilder(e, t) {
          var r,
            a = tV.mathMLnode(e.label);
          if (
            (a.setAttribute(
              "minsize",
            ...
            var n = tj(tR(e.body, t));
            if (e.below) {
              var i = tj(tR(e.below, t));
              r = new tT.MathNode("munderover", [a, i, n]);
            } else r = new tT.MathNode("mover", [a, n]);
          } else if (e.below) {
            var s = tj(tR(e.below, t));
            r = new tT.MathNode("munder", [a, s]);
          } else (r = tj()), (r = new tT.MathNode("mover", [a, r]));
          return r;
        },
      });
      var t$ = {
      ...
      ts({
        ...
        htmlBuilder(e, t) {
          var r = t.havingStyle(t.style.sup()),
            a = e8.wrapFragment(tw(e.label, r, t), t);
          return (
            a.classes.push("cd-label-" + e.side),
            (a.style.bottom = J(0.8 - a.depth)),
            (a.height = 0),
            (a.depth = 0),
            a
          );
        ...
        mathmlBuilder(e, t) {
          var r = new tT.MathNode("mrow", [tR(e.label, t)]);
          return (
            (r = new tT.MathNode("mpadded", [r])).setAttribute("width", "0"),
        ...
        ts({
          ...
          htmlBuilder(e, t) {
            var r = e8.wrapFragment(tw(e.fragment, t), t);
            return r.classes.push("cd-vert-arrow"), r;
          },
          mathmlBuilder: (e, t) => new tT.MathNode("mrow", [tR(e.fragment, t)]),
        }),
        ts({
          type: "textord",
          names: ["\\@char"],
          ...
          handler(e, t) {
            for (
              var r,
                { parser: a } = e,
                n = tG(t[0], "ordgroup").body,
                s = "",
                o = 0;
              o < n.length;
              o++
            )
              s += tG(n[o], "textord").text;
            var l = parseInt(s);
            if (isNaN(l)) throw new i("\\@char has non-numeric argument " + s);
            if (l < 0 || l >= 1114111)
      ...
      var tQ = (e, t) => {
          var r = tg(e.body, t.withColor(e.color), !1);
          return e8.makeFragment(r);
        },
        t0 = (e, t) => {
          var r = tN(e.body, t.withColor(e.color)),
            a = new tT.MathNode("mstyle", r);
      ...
      ts({
        ...
        handler(e, t) {
          var { parser: r } = e,
            a = tG(t[0], "color-token").color,
            n = t[1];
          return { type: "color", mode: r.mode, color: a, body: th(n) };
        },
        htmlBuilder: tQ,
        mathmlBuilder: t0,
      }),
        ...
        ts({
          ...
          handler(e, t, r) {
            ...
            return {
              ...
              mode: a.mode,
              newLine: i,
              size: n && tG(n, "size").value,
            };
          },
          htmlBuilder(e, t) {
            var r = e8.makeSpan(["mspace"], [], t);
            return (
              e.newLine &&
                (r.classes.push("newline"),
                e.size && (r.style.marginTop = J(K(e.size, t)))),
              r
            );
          },
          mathmlBuilder(e, t) {
            ...
            return (
              e.newLine &&
                ...
                e.size && r.setAttribute("height", J(K(e.size, t)))),
              r
            );
          },
        });
      var t1 = {
        ...
        t4 = (e) => {
          var t = e.text;
          if (/^(?:[\\{}$&#^_]|EOF)$/.test(t))
            throw new i("Expected a control sequence", e);
          return t;
        },
        t5 = (e) => {
      ...
      ts({
          ...
          if (t1[a.text])
            return (
              ("\\global" === r || "\\\\globallong" === r) &&
                (a.text = t1[a.text]),
              tG(t.parseFunction(), "internal")
            );
          throw new i("Invalid token after macro prefix", a);
        },
      }),
        ts({
          type: "internal",
          ...
          handler(e) {
            var t,
              { parser: r, funcName: a } = e,
              n = r.gullet.popToken(),
              s = n.text;
            if (/^(?:[\\{}$&#^_]|EOF)$/.test(s))
              throw new i("Expected a control sequence", n);
            for (var o = 0, l = [[]]; "{" !== r.gullet.future().text; )
              if ("#" === (n = r.gullet.popToken()).text) {
                if ("{" === r.gullet.future().text) {
                  (t = r.gullet.future()), l[o].push("{");
                  break;
                }
                if (((n = r.gullet.popToken()), !/^[1-9]$/.test(n.text)))
                  throw new i('Invalid argument number "' + n.text + '"');
                if (parseInt(n.text) !== o + 1)
                  throw new i('Argument number "' + n.text + '" out of order');
                o++, l.push([]);
              } else if ("EOF" === n.text)
                throw new i("Expected a macro definition");
              else l[o].push(n.text);
            var { tokens: h } = r.gullet.consumeArg();
            return (
              t && h.unshift(t),
              ("\\edef" === a || "\\xdef" === a) &&
                (h = r.gullet.expandTokens(h)).reverse(),
              r.gullet.macros.set(
                s,
        ...
        ts({
          ...
          handler(e) {
            var { parser: t, funcName: r } = e,
              a = t4(t.gullet.popToken());
            t.gullet.consumeSpaces();
            var n = t5(t);
            return (
              t6(t, a, n, "\\\\globallet" === r),
      ...
      var t7 = function (e, t, r) {
        ...
        t3 = function (e, t, r, a) {
          var n = r.havingBaseStyle(t),
            i = e8.makeSpan(a.concat(n.sizingClasses(r)), [e], r),
        ...
        t2 = function (e, t, r, a, n, i) {
          var s = t3(e8.makeSymbol(e, "Main-Regular", n, a), t, a, i);
          return r && t8(s, a, t), s;
        },
        t9 = function (e, t, r, a, n, i) {
          var s = e8.makeSymbol(e, "Size" + t + "-Regular", n, a),
            o = t3(
        ...
        rt = function (e, t, r) {
          var a = P["Size4-Regular"][e.charCodeAt(0)]
              ? P["Size4-Regular"][e.charCodeAt(0)][4]
              : P["Size1-Regular"][e.charCodeAt(0)][4],
            n = new eh("inner", E(e, Math.round(1e3 * t))),
            i = new el([n], {
              width: J(a),
              height: J(t),
              style: "width:" + J(a),
        ...
        rr = { type: "kern", size: -0.008 },
        ra = ["|", "\\lvert", "\\rvert", "\\vert"],
        rn = ["\\|", "\\lVert", "\\rVert", "\\Vert"],
        ri = function (e, t, r, a, n, i) {
          (s = l = h = e), (o = null);
          var s,
            o,
            l,
          ...
          var w = p + f + v,
            k = Math.max(0, Math.ceil((t - w) / (b * d))),
            S = w + k * b * d,
            M = a.fontMetrics().axisHeight;
          r && (M *= a.sizeMultiplier);
          var z = S / 2 - M,
            A = [];
          if ((A.push(re(h, m, n)), A.push(rr), null === o))
            A.push(rt(l, S - p - f + 0.016, a));
          else {
            var T = (S - p - f - v) / 2 + 0.016;
            A.push(rt(l, T, a)),
              A.push(rr),
              A.push(re(o, m, n)),
              A.push(rr),
        ...
        rs = function (e, t, r, a, n) {
          ...
          return e8.makeSvgSpan(["hide-tail"], [o], n);
        },
        ro = [
          "(",
          "\\lparen",
        ...
        rg = function (e, t, r, a) {
          for (
            var n = Math.min(2, 3 - a.style.size), i = n;
            i < r.length && "stack" !== r[i].type;
            i++
          ) {
            var s = t7(e, rd(r[i]), "math"),
              o = s.height + s.depth;
            if (
              ("small" === r[i].type &&
                (o *= a.havingBaseStyle(r[i].style).sizeMultiplier),
              o > t)
            )
              return r[i];
          }
        ...
        rf = function (e, t, r, a, n, i) {
          "<" === e || "\\lt" === e || "⟨" === e
            ? (e = "\\langle")
            : (">" === e || "\\gt" === e || "⟩" === e) && (e = "\\rangle"),
            (s = x.contains(rh, e) ? rc : x.contains(ro, e) ? ru : rp);
          var s,
            o = rg(e, t, s, a);
          return "small" === o.type
        ...
        rv = {
          sqrtImage: function (e, t) {
            var r,
              ...
              i = rg("\\surd", e * n.sizeMultiplier, ru, n),
              s = n.sizeMultiplier,
              o = Math.max(
                0,
          ...
          sizedDelim: function (e, t, r, a, n) {
            if (
              ("<" === e || "\\lt" === e || "⟨" === e
                ? (e = "\\langle")
                : (">" === e || "\\gt" === e || "⟩" === e) && (e = "\\rangle"),
              x.contains(ro, e) || x.contains(rh, e))
            )
              return t9(e, t, !1, r, a, n);
            if (x.contains(rl, e)) return ri(e, rm[t], !1, r, a, n);
          ...
          leftRightDelim: function (e, t, r, a, n, i) {
            var s = a.fontMetrics().axisHeight * a.sizeMultiplier,
              o = 5 / a.fontMetrics().ptPerEm,
              l = Math.max(t - s, r + s);
            return rf(e, Math.max((l / 500) * 901, 2 * l - o), !0, a, n, i);
          },
        },
        rb = {
      ...
      function rx(e, t) {
        var r = tY(e);
        if (r && x.contains(ry, r.text)) return r;
        if (r)
          throw new i(
      ...
      ts({
        ...
        handler: (e, t) => {
          ...
          return {
            type: "delimsizing",
            mode: e.parser.mode,
            size: rb[e.funcName].size,
            mclass: rb[e.funcName].mclass,
            delim: r.text,
          };
        },
        htmlBuilder: (e, t) =>
          "." === e.delim
            ? e8.makeSpan([e.mclass])
            : rv.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
        mathmlBuilder: (e) => {
          var t = [];
          "." !== e.delim && t.push(tB(e.delim, e.mode));
          var r = new tT.MathNode("mo", t);
          "mopen" === e.mclass || "mclose" === e.mclass
            ? r.setAttribute("fence", "true")
            : r.setAttribute("fence", "false"),
            r.setAttribute("stretchy", "true");
          var a = J(rv.sizeToMaxHeight[e.size]);
        ...
        ts({
          ...
          handler: (e, t) => {
            ...
            var i = tG(a.parseFunction(), "leftright-right");
            return {
              type: "leftright",
              mode: a.mode,
              body: n,
          ...
          htmlBuilder: (e, t) => {
            ...
            if (
              ...
              (r =
                "." === e.left
                  ? tx(t, ["mopen"])
                  : rv.leftRightDelim(e.left, i, s, t, e.mode, ["mopen"])),
              n.unshift(r),
              o)
            )
            ...
            if ("." === e.right) a = tx(t, ["mclose"]);
              ...
              a = rv.leftRightDelim(e.right, i, s, c, e.mode, ["mclose"]);
            }
            return n.push(a), e8.makeSpan(["minner"], n, t);
          },
          mathmlBuilder: (e, t) => {
            rw(e);
            var r = tN(e.body, t);
            if ("." !== e.left) {
              var a = new tT.MathNode("mo", [tB(e.left, e.mode)]);
              a.setAttribute("fence", "true"), r.unshift(a);
            }
            if ("." !== e.right) {
              var n = new tT.MathNode("mo", [tB(e.right, e.mode)]);
        ...
        ts({
          ...
          htmlBuilder: (e, t) => {
            ...
            if ("." === e.delim) r = tx(t, []);
              ...
              r = rv.sizedDelim(e.delim, 1, t, e.mode, []);
      ...
      var rk = (e, t) => {
          var r,
            a,
            n = e8.wrapFragment(tw(e.body, t), t),
            i = e.label.substr(1),
            s = t.sizeMultiplier,
            o = 0,
            l = x.isCharacterBox(e.body);
          if ("sout" === i)
            ((r = e8.makeSpan(["stretchy", "sout"])).height =
              t.fontMetrics().defaultRuleThickness / s),
              (o = -0.5 * t.fontMetrics().xHeight);
          else if ("phase" === i) {
            var h = K({ number: 0.6, unit: "pt" }, t),
              m = K({ number: 0.35, unit: "ex" }, t);
            s /= t.havingBaseSizing().sizeMultiplier;
            var c = n.height + n.depth + h + m;
            n.style.paddingLeft = J(c / 2 + h);
            ...
            /box/.test(i)
              ...
              /fbox|boxed|fcolorbox/.test(i)
                ? ((r.style.borderStyle = "solid"),
                  (r.style.borderWidth = J(f)))
                : "angl" === i &&
                  0.049 !== f &&
                  ((r.style.borderTopWidth = J(f)),
                  (r.style.borderRightWidth = J(f))),
              (o = n.depth + g),
              e.backgroundColor &&
          ...
          return (/cancel/.test(i) &&
            ((a.height = n.height), (a.depth = n.depth)),
          /cancel/.test(i) && !l)
            ? e8.makeSpan(["mord", "cancel-lap"], [a], t)
            : e8.makeSpan(["mord"], [a], t);
        },
        rS = (e, t) => {
          var r = 0,
            a = new tT.MathNode(
      ...
      var rB = (e) => {
        if (!e.parser.settings.displayMode)
          throw new i("{" + e.envName + "} can be used only in display mode.");
      };
      function rC(e) {
        ...
        function k() {
          x &&
            (e.gullet.macros.get("\\df@tag")
              ? (x.push(e.subparse([new n("\\df@tag")])),
                e.gullet.macros.set("\\df@tag", void 0, !0))
              : x.push(!!m && "1" === e.gullet.macros.get("\\@eqnsw")));
        }
        for (w(), y.push(rT(e)); ; ) {
          ...
          if ("&" === M) {
            ...
            throw new i("Expected & or \\\\ or \\cr or \\end", e.nextToken);
        }
        return (
          e.gullet.endGroup(),
          e.gullet.endGroup(),
      ...
      var rI = function (e, t) {
          ...
          e.colSeparationType &&
            ...
            (d =
              0.2778 *
              (t.havingStyle(N.SCRIPT).sizeMultiplier / t.sizeMultiplier));
          var g =
              "CD" === e.colSeparationType
                ? K({ number: 3, unit: "ex" }, t)
                : 12 * u,
            f = 3 * u,
            v = e.arraystretch * g,
            b = 0.7 * v,
          ...
          function k(e) {
            for (var t = 0; t < e.length; ++t)
              t > 0 && (w += 0.25), c.push({ pos: w, isDashed: e[t] });
          }
          for (k(l[0]), r = 0; r < e.body.length; ++r) {
            var S = e.body[r],
              M = b,
              z = y;
          ...
          var q = w / 2 + t.fontMetrics().axisHeight,
            I = e.cols || [],
            R = [],
            O = [];
          ...
          for (a = 0, s = 0; a < h || s < I.length; ++a, ++s) {
            for (var P = I[s] || {}, F = !0; "separator" === P.type; ) {
              if (
                (F ||
                ...
                var V = "|" === P.separator ? "solid" : "dashed",
                  G = e8.makeSpan(["vertical-separator"], [], t);
                (G.style.height = J(w)),
                  (G.style.borderRightWidth = J(p)),
                  (G.style.borderRightStyle = V),
                  (G.style.margin = "0 " + J(-p / 2));
                var U = w - q;
                U && (G.style.verticalAlign = J(-U)), R.push(G);
              } else throw new i("Invalid separator type: " + P.separator);
              (P = I[++s] || {}), (F = !1);
            }
            if (!(a >= h)) {
              var Y = void 0;
              (a > 0 || e.hskipBeforeAndAfter) &&
                0 !== (Y = x.deflt(P.pregap, d)) &&
                (((n = e8.makeSpan(["arraycolsep"], [])).style.width = J(Y)),
                R.push(n));
              var X = [];
              for (r = 0; r < o; ++r) {
                var W = m[r],
                ...
                if (_) {
                  ...
                  (_.depth = W.depth),
                    (_.height = W.height),
                    X.push({ type: "elem", elem: _, shift: j });
                }
              }
              (X = e8.makeVList(
                ...
                (a < h - 1 || e.hskipBeforeAndAfter) &&
                  0 !== (Y = x.deflt(P.postgap, d)) &&
                  (((n = e8.makeSpan(["arraycolsep"], [])).style.width = J(Y)),
                  R.push(n));
            }
          }
          if (((m = e8.makeSpan(["mtable"], R)), c.length > 0)) {
            for (
              var $ = e8.makeLineSpan("hline", t, p),
              ...
              var ee = c.pop(),
                et = ee.pos - q;
              ee.isDashed
                ? Q.push({ type: "elem", elem: Z, shift: et })
                : Q.push({ type: "elem", elem: $, shift: et });
            }
            m = e8.makeVList(
        ...
        rR = { c: "center ", l: "left ", r: "right " },
        rO = function (e, t) {
          for (
            var r = [],
              a = new tT.MathNode("mtd", [], ["mtr-glue"]),
              n = new tT.MathNode("mtd", [], ["mml-eqn-num"]),
              i = 0;
            i < e.body.length;
            i++
          ) {
            for (var s = e.body[i], o = [], l = 0; l < s.length; l++)
              o.push(new tT.MathNode("mtd", [tR(s[l], t)]));
            e.tags &&
              e.tags[i] &&
              (o.unshift(a), o.push(a), e.leqno ? o.unshift(n) : o.push(n)),
              r.push(new tT.MathNode("mtr", o));
          }
          ...
          if (e.cols && e.cols.length > 0) {
            ...
            "separator" === u[0].type && ((c += "top "), (f = 1)),
              "separator" === u[u.length - 1].type &&
                ((c += "bottom "), (v -= 1));
            for (var b = f; b < v; b++)
              "align" === u[b].type
                ? ((p += rR[u[b].align]), g && (d += "none "), (g = !0))
                : "separator" === u[b].type &&
                  g &&
                  ((d += "|" === u[b].separator ? "solid " : "dashed "),
                  (g = !1));
        ...
        rH = function (e, t) {
          ...
          if (t[0] && "ordgroup" === t[0].type) {
            for (var m = "", c = 0; c < t[0].body.length; c++)
              m += tG(t[0].body[c], "textord").text;
            l = 2 * (r = Number(m));
          }
          var p = !l;
          o.body.forEach(function (e) {
            for (var t = 1; t < e.length; t += 2) {
              var a = tG(e[t], "styling");
              tG(a.body[0], "ordgroup").body.unshift(h);
            }
          ...
          for (var u = 0; u < l; ++u) {
            var d = "r",
              g = 0;
            u % 2 == 1 ? (d = "l") : u > 0 && p && (g = 1),
              (a[u] = { type: "align", align: d, pregap: g, postgap: 0 });
          }
      ...
      rz({
        ...
        rz({
          ...
          handler(e) {
            ...
            var s = rq(e.parser, a, rN(e.envName)),
              o = Math.max(0, ...s.body.map((e) => e.length));
            return (
              (s.cols = Array(o).fill({ type: "align", align: r })),
              t
                ? {
                    type: "leftright",
                    mode: e.mode,
        ...
        rz({
          ...
          props: { numArgs: 0 },
          handler(e) {
            var t = rq(e.parser, { arraystretch: 0.5 }, "script");
        ...
        rz({
          ...
          handler(e, t) {
            ...
            if (
              (a = rq(e.parser, a, "script")).body.length > 0 &&
              a.body[0].length > 1
            )
              throw new i("{subarray} can contain only one column");
            return a;
        ...
        rz({
          ...
          props: { numArgs: 0 },
          handler(e) {
            x.contains(["gather", "gather*"], e.envName) && rB(e);
            var t = {
              cols: [{ type: "align", align: "c" }],
              addJot: !0,
              colSeparationType: "gather",
              autoTag: rC(e.envName),
              emptySingleRow: !0,
              leqno: e.parser.settings.leqno,
            };
            return rq(e.parser, t, "display");
          },
          htmlBuilder: rI,
          mathmlBuilder: rO,
        }),
            ...
            (function (e) {
              ...
              for (
                ...
                if ("&" === r || "\\\\" === r) e.consume();
                  ...
                  throw new i("Expected \\\\ or \\cr or \\end", e.nextToken);
              }
              for (var a = [], n = [a], s = 0; s < t.length; s++) {
                for (var o = t[s], l = tZ(), h = 0; h < o.length; h++)
                  if (tK(o[h])) {
                    a.push(l);
                    var m = tU(o[(h += 1)]).text,
                      c = [, ,];
                    ...
                    else if ("<>AV".indexOf(m) > -1)
                      for (var p = 0; p < 2; p++) {
                        for (var u = !0, d = h + 1; d < o.length; d++) {
                          if (tJ(o[d], m)) {
                            (u = !1), (h = d);
                            break;
                          }
                ...
                s % 2 == 0 ? a.push(l) : a.shift(), (a = []), n.push(a);
              }
              return (
                e.gullet.endGroup(),
                e.gullet.endGroup(),
        ...
        ts({
          ...
          handler(e, t) {
            ...
            for (var s = "", o = 0; o < n.body.length; ++o)
              s += tG(n.body[o], "textord").text;
            if ("\\begin" === a) {
              if (!rM.hasOwnProperty(s))
                throw new i("No such environment: " + s, n);
              var l = rM[s],
              ...
              r.expect("\\end", !1);
              var u = r.nextToken,
                d = tG(r.parseFunction(), "environment");
              if (d.name !== s)
                throw new i(
                  "Mismatch: \\begin{" +
                    s +
            ...
            return { type: "environment", mode: r.mode, name: s, nameGroup: n };
          },
        });
      var rE = e8.makeSpan;
      function rL(e, t) {
        var r = tg(e.body, t, !0);
        return rE([e.mclass], r, t);
      }
      function rD(e, t) {
        var r,
          a = tN(e.body, t);
      ...
      ts({
        ...
        handler(e, t) {
          ...
          return {
            ...
            mclass: rP(t[0]),
            body: th(t[1]),
            isCharacterBox: x.isCharacterBox(t[1]),
          };
        },
      }),
        ts({
          ...
          handler(e, t) {
            ...
            return {
              ...
              mclass: r,
              body: [l],
              isCharacterBox: x.isCharacterBox(l),
            };
          },
          htmlBuilder: rL,
          mathmlBuilder: rD,
      ...
      var rU = (e, t) => {
        ...
        rY = (e, t) => {
          var r,
            ...
            g = u.fracDen();
          r = t.havingStyle(d);
          var f = tw(e.numer, r, t);
          if (e.continued) {
            var v = 8.5 / t.fontMetrics().ptPerEm,
              b = 3.5 / t.fontMetrics().ptPerEm;
            (f.height = f.height < v ? v : f.height),
              (f.depth = f.depth < b ? b : f.depth);
          }
          r = t.havingStyle(g);
          var y = tw(e.denom, r, t);
          if (
            (e.hasBarLine
              ? (e.barSize
                  ? ((n = K(e.barSize, t)),
                    (a = e8.makeLineSpan("frac-line", t, n)))
                  : (a = e8.makeLineSpan("frac-line", t)),
                (n = a.height),
                (i = a.height))
              : ((a = null),
                (n = 0),
                (i = t.fontMetrics().defaultRuleThickness)),
            u.size === N.DISPLAY.size || "display" === e.size
              ? ((s = t.fontMetrics().num1),
                (o = n > 0 ? 3 * i : 7 * i),
                (l = t.fontMetrics().denom1))
              : (n > 0
                  ? ((s = t.fontMetrics().num2), (o = i))
                  : ((s = t.fontMetrics().num3), (o = 3 * i)),
                (l = t.fontMetrics().denom2)),
            a)
          ) {
            var x = t.fontMetrics().axisHeight;
            s - f.depth - (x + 0.5 * n) < o &&
              (s += o - (s - f.depth - (x + 0.5 * n))),
              x - 0.5 * n - (y.height - l) < o &&
                (l += o - (x - 0.5 * n - (y.height - l)));
            var w = -(x - 0.5 * n);
            h = e8.makeVList(
              {
                positionType: "individualShift",
                children: [
                  { type: "elem", elem: y, shift: l },
                  { type: "elem", elem: a, shift: w },
          ...
          return (
            (r = t.havingStyle(u)),
            (h.height *= r.sizeMultiplier / t.sizeMultiplier),
            (h.depth *= r.sizeMultiplier / t.sizeMultiplier),
            (m =
        ...
        rX = (e, t) => {
          var r = new tT.MathNode("mfrac", [tR(e.numer, t), tR(e.denom, t)]);
          if (e.hasBarLine) {
            if (e.barSize) {
              var a = K(e.barSize, t);
              r.setAttribute("linethickness", J(a));
            }
          } else r.setAttribute("linethickness", "0px");
          var n = rU(e.size, t.style);
      ...
      var rW = ["display", "text", "script", "scriptscript"],
        r_ = function (e) {
          var t = null;
      ...
      ts({
        ...
        handler(e, t) {
          var r,
            ...
            i = t[5],
            s = tl(t[0]),
            o = "atom" === s.type && "open" === s.family ? r_(s.text) : null,
            l = tl(t[1]),
            h = "atom" === l.type && "close" === l.family ? r_(l.text) : null,
            m = tG(t[2], "size"),
            c = null;
          ...
          return (
            "ordgroup" === u.type
              ? u.body.length > 0 &&
                (p = rW[Number(tG(u.body[0], "textord").text)])
              : (p = rW[Number((u = tG(u, "textord")).text)]),
            {
              type: "genfrac",
              mode: a.mode,
              numer: n,
      ...
      var rj = (e, t) => {
        ...
        "supsub" === e.type
          ? ((r = e.sup
              ? tw(e.sup, t.havingStyle(i.sup()), t)
              : tw(e.sub, t.havingStyle(i.sub()), t)),
            (a = tG(e.base, "horizBrace")))
          : (a = tG(e, "horizBrace"));
        var s = tw(a.base, t.havingBaseStyle(N.DISPLAY)),
          o = tV.svgSpan(a, t);
        if (
          (a.isOver
            ? (n = e8.makeVList(
          ...
          var l = e8.makeSpan(["mord", a.isOver ? "mover" : "munder"], [n], t);
          n = a.isOver
            ? e8.makeVList(
                {
                  positionType: "firstBaseline",
      ...
      ts({
        ...
        ts({
          ...
          handler: (e, t) => {
            ...
            return r.settings.isTrusted({ command: "\\href", url: n })
              ? { type: "href", mode: r.mode, href: n, body: th(a) }
              : r.formatUnsupportedCmd("\\href");
          },
          htmlBuilder: (e, t) => {
            var r = tg(e.body, t, !1);
            return e8.makeAnchor(e.href, [], r, t);
          },
          mathmlBuilder: (e, t) => {
            var r = tI(e.body, t);
            return (
              r instanceof tz || (r = new tz("mrow", [r])),
        ...
        ts({
          ...
          handler: (e, t) => {
            ...
            for (var n = [], i = 0; i < a.length; i++) {
              var s = a[i];
              "~" === s && (s = "\\textasciitilde"),
                n.push({ type: "textord", mode: "text", text: s });
            }
            var o = { type: "text", mode: r.mode, font: "\\texttt", body: n };
            return { type: "href", mode: r.mode, href: a, body: th(o) };
          },
        }),
        ts({
          type: "hbox",
          ...
          handler(e, t) {
            var { parser: r } = e;
            return { type: "hbox", mode: r.mode, body: th(t[0]) };
          },
          htmlBuilder(e, t) {
            var r = tg(e.body, t, !1);
            return e8.makeFragment(r);
          },
          mathmlBuilder: (e, t) => new tT.MathNode("mrow", tN(e.body, t)),
        }),
        ts({
          type: "html",
          ...
          handler: (e, t) => {
            ...
            switch (n) {
              case "\\htmlClass":
                (h.class = o), (r = { command: "\\htmlClass", class: o });
                break;
              case "\\htmlId":
                (h.id = o), (r = { command: "\\htmlId", id: o });
                break;
              case "\\htmlStyle":
                (h.style = o), (r = { command: "\\htmlStyle", style: o });
                break;
              case "\\htmlData":
                for (var m = o.split(","), c = 0; c < m.length; c++) {
                  var p = m[c].split("=");
                  if (2 !== p.length)
            ...
            return a.settings.isTrusted(r)
              ? { type: "html", mode: a.mode, attributes: h, body: th(l) }
        ...
        ts({
          ...
          mathmlBuilder: (e, t) => tI(e.mathml, t),
        });
      var r$ = function (e) {
        if (/^[-+]? *(\d+(\.\d*)?|\.\d+)$/.test(e))
      ...
      ts({
        ...
        handler: (e, t, r) => {
          ...
          if (r[0])
            for (
              var h = tG(r[0], "raw").string.split(","), m = 0;
              m < h.length;
              m++
            ) {
              var c = h[m].split("=");
        ...
        htmlBuilder: (e, t) => {
          var r = K(e.height, t),
            a = 0;
          e.totalheight.number > 0 && (a = K(e.totalheight, t) - r);
          var n = 0;
          e.width.number > 0 && (n = K(e.width, t));
          var i = { height: J(r + a) };
          n > 0 && (i.width = J(n)), a > 0 && (i.verticalAlign = J(-a));
          var s = new ei(e.src, e.alt, i);
        ...
        mathmlBuilder: (e, t) => {
          ...
          if (
            (e.totalheight.number > 0 &&
              ((n = K(e.totalheight, t) - a), r.setAttribute("valign", J(-n))),
            r.setAttribute("height", J(a + n)),
            e.width.number > 0)
          ) {
            var i = K(e.width, t);
            r.setAttribute("width", J(i));
          }
        ...
        ts({
          ...
          htmlBuilder: (e, t) => e8.makeGlue(e.dimension, t),
          mathmlBuilder(e, t) {
            var r = K(e.dimension, t);
        ...
        ts({
          ...
          htmlBuilder: (e, t) => {
            "clap" === e.alignment
              ? ((r = e8.makeSpan([], [tw(e.body, t)])),
                (r = e8.makeSpan(["inner"], [r], t)))
              : (r = e8.makeSpan(["inner"], [tw(e.body, t)]));
            var r,
              a = e8.makeSpan(["fix"], []),
              n = e8.makeSpan([e.alignment], [r, a], t),
              i = e8.makeSpan(["strut"]);
            return (
              (i.style.height = J(n.height + n.depth)),
              n.depth && (i.style.verticalAlign = J(-n.depth)),
              n.children.unshift(i),
              (n = e8.makeSpan(["thinbox"], [n], t)),
              e8.makeSpan(["mord", "vbox"], [n], t)
            );
          },
          mathmlBuilder: (e, t) => {
            var r = new tT.MathNode("mpadded", [tR(e.body, t)]);
            if ("rlap" !== e.alignment) {
        ...
        ts({
          ...
          handler(e, t) {
            ...
            a.switchMode("math");
            var i = "\\(" === r ? "\\)" : "$",
              s = a.parseExpression(!1, i);
            return (
              a.expect(i),
              a.switchMode(n),
              { type: "styling", mode: a.mode, style: "text", body: s }
            );
          },
        }),
        ts({
      ...
      ts({
        ...
        mathmlBuilder: (e, t) => tI(rZ(e, t), t),
      });
      var rK = (e, t, r, a, n, i, s) => {
          e = e8.makeSpan([], [e]);
          var o,
            l,
            h,
            m = r && x.isCharacterBox(r);
          if (t) {
            var c = tw(t, a.havingStyle(n.sup()), a);
            l = {
              elem: c,
              kern: Math.max(
          ...
          if (r) {
            var p = tw(r, a.havingStyle(n.sub()), a);
            o = {
              elem: p,
              kern: Math.max(
            ...
            h = e8.makeVList(
              {
                ...
                children: [
                  ...
                  { type: "elem", elem: o.elem, marginLeft: J(-i) },
                  { type: "kern", size: o.kern },
                  { type: "elem", elem: e },
                  { type: "kern", size: l.kern },
                  { type: "elem", elem: l.elem, marginLeft: J(i) },
                  { type: "kern", size: a.fontMetrics().bigOpSpacing5 },
                ],
              },
              a,
          ...
          var f = [h];
          if (o && 0 !== i && !m) {
            var v = e8.makeSpan(["mspace"], [], a);
            (v.style.marginRight = J(i)), f.unshift(v);
          }
          return e8.makeSpan(["mop", "op-limits"], f, a);
        },
        rJ = ["\\smallint"],
        rQ = (e, t) => {
          var r,
            ...
            s = !1;
          "supsub" === e.type
            ? ((r = e.sup), (a = e.sub), (n = tG(e.base, "op")), (s = !0))
            : (n = tG(e, "op"));
          var o = t.style,
            l = !1;
          if (
            (o.size === N.DISPLAY.size &&
              n.symbol &&
              !x.contains(rJ, n.name) &&
              (l = !0),
            n.symbol)
          ) {
            ...
            if (
              ...
              (i = e8.makeSymbol(n.name, h, "math", t, [
                "mop",
                "op-symbol",
                l ? "large-op" : "small-op",
              ])),
            ...
            var u = tg(n.body, t, !0);
            1 === u.length && u[0] instanceof eo
              ? ((i = u[0]).classes[0] = "mop")
              : (i = e8.makeSpan(["mop"], u, t));
          } else {
            for (var d = [], g = 1; g < n.name.length; g++)
              d.push(e8.mathsym(n.name[g], n.mode, t));
            i = e8.makeSpan(["mop"], d, t);
          }
          var f = 0,
            v = 0;
          ...
          s)
            ? rK(i, r, a, t, o, v, f)
            : (f && ((i.style.position = "relative"), (i.style.top = J(f))), i);
        },
        r0 = (e, t) => {
          var r;
          if (e.symbol)
            (r = new tz("mo", [tB(e.name, e.mode)])),
              x.contains(rJ, e.name) && r.setAttribute("largeop", "false");
          else if (e.body) r = new tz("mo", tN(e.body, t));
          else {
            r = new tz("mi", [new tA(e.name.slice(1))]);
            var a = new tz("mo", [tB("⁡", "text")]);
            r = e.parentIsSupSub ? new tz("mrow", [r, a]) : tM([r, a]);
          }
          return r;
        },
        r1 = {
      ...
      var r5 = (e, t) => {
        ...
        if (
          ...
          i = e8.makeSpan(["mop"], o, t);
        } else i = e8.makeSpan(["mop"], [], t);
        return s ? rK(i, r, a, t, t.style, 0, 0) : i;
      };
      function r6(e, t, r) {
        for (
          var a = tg(e, t, !1), n = t.sizeMultiplier / r.sizeMultiplier, i = 0;
          i < a.length;
          i++
        ) {
          ...
          s < 0
            ...
            : a[i].classes[s + 1] === "reset-size" + t.size &&
              (a[i].classes[s + 1] = "reset-size" + r.size),
            (a[i].height *= n),
            (a[i].depth *= n);
        }
        return e8.makeFragment(a);
      }
      ts({
        type: "operatorname",
        ...
        mathmlBuilder: (e, t) => {
          for (
            var r = tN(e.body, t.withFont("mathrm")), a = !0, n = 0;
            n < r.length;
            n++
          ) {
            var i = r[n];
            if (i instanceof tT.SpaceNode);
            else if (i instanceof tT.MathNode)
              switch (i.type) {
                case "mi":
                case "mn":
                case "ms":
                ...
                case "mo":
                  var s = i.children[0];
                  1 === i.children.length && s instanceof tT.TextNode
                    ? (s.text = s.text
                        .replace(/\u2212/, "-")
                        .replace(/\u2217/, "*"))
                    : (a = !1);
          ...
          var h = new tT.MathNode("mo", [tB("⁡", "text")]);
          return e.parentIsSupSub
            ? new tT.MathNode("mrow", [l, h])
            : tT.newDocumentFragment([l, h]);
        },
      }),
        (rA["\\operatorname"] =
        ...
        to({
          ...
          htmlBuilder: (e, t) =>
            e.semisimple
              ? e8.makeFragment(tg(e.body, t, !1))
              : e8.makeSpan(["mord"], tg(e.body, t, !0), t),
          mathmlBuilder: (e, t) => tI(e.body, t, !0),
        }),
        ts({
          type: "overline",
          names: ["\\overline"],
          ...
          htmlBuilder(e, t) {
            var r = tw(e.body, t.havingCrampedStyle()),
              a = e8.makeLineSpan("overline-line", t),
          ...
          mathmlBuilder(e, t) {
            ...
            r.setAttribute("stretchy", "true");
            var a = new tT.MathNode("mover", [tR(e.body, t), r]);
            return a.setAttribute("accent", "true"), a;
          },
        }),
        ts({
          ...
          handler: (e, t) => {
            var { parser: r } = e,
              a = t[0];
            return { type: "phantom", mode: r.mode, body: th(a) };
          },
          htmlBuilder: (e, t) => {
            var r = tg(e.body, t.withPhantom(), !1);
            return e8.makeFragment(r);
          },
          mathmlBuilder: (e, t) => {
            var r = tN(e.body, t);
        ...
        ts({
          ...
          htmlBuilder: (e, t) => {
            var r = e8.makeSpan([], [tw(e.body, t.withPhantom())]);
          ...
          mathmlBuilder: (e, t) => {
            var r = tN(th(e.body), t),
              a = new tT.MathNode("mphantom", r),
              n = new tT.MathNode("mpadded", [a]);
            return (
        ...
        ts({
          ...
          htmlBuilder: (e, t) => {
            var r = e8.makeSpan(["inner"], [tw(e.body, t.withPhantom())]),
              a = e8.makeSpan(["fix"], []);
            return e8.makeSpan(["mord", "rlap"], [r, a], t);
          },
          mathmlBuilder: (e, t) => {
            var r = tN(th(e.body), t),
              a = new tT.MathNode("mphantom", r),
        ...
        ts({
          ...
          handler(e, t, r) {
            ...
            return {
              type: "rule",
              mode: a.mode,
              shift: n && tG(n, "size").value,
              width: i.value,
              height: s.value,
            };
          },
          htmlBuilder(e, t) {
            var r = e8.makeSpan(["mord", "rule"], [], t),
              a = K(e.width, t),
              n = K(e.height, t),
              i = e.shift ? K(e.shift, t) : 0;
            return (
              (r.style.borderRightWidth = J(a)),
              (r.style.borderTopWidth = J(n)),
              (r.style.bottom = J(i)),
              (r.width = a),
              (r.height = n + i),
              (r.depth = -i),
          ...
          mathmlBuilder(e, t) {
            var r = K(e.width, t),
              a = K(e.height, t),
              n = e.shift ? K(e.shift, t) : 0,
              i = (t.color && t.getColor()) || "black",
              s = new tT.MathNode("mspace");
            s.setAttribute("mathbackground", i),
              s.setAttribute("width", J(r)),
              s.setAttribute("height", J(a));
            var o = new tT.MathNode("mpadded", [s]);
            return (
              n >= 0
                ? o.setAttribute("height", J(n))
                : (o.setAttribute("height", J(n)),
                  o.setAttribute("depth", J(-n))),
              o.setAttribute("voffset", J(n)),
              o
            );
          },
        });
      ...
      ts({
        ...
        htmlBuilder: (e, t) => {
          ...
          return r6(e.body, r, t);
        },
        mathmlBuilder: (e, t) => {
          var r = t.havingSize(e.size),
            a = tN(e.body, r),
            n = new tT.MathNode("mstyle", a);
          return n.setAttribute("mathsize", J(r.sizeMultiplier)), n;
        },
      }),
        ts({
          type: "smash",
          ...
          handler: (e, t, r) => {
            var { parser: a } = e,
              n = !1,
              i = !1,
              s = r[0] && tG(r[0], "ordgroup");
            if (s)
              for (var o = "", l = 0; l < s.body.length; ++l)
                if ("t" === (o = s.body[l].text)) n = !0;
                else if ("b" === o) i = !0;
                else {
                  (n = !1), (i = !1);
                  break;
        ...
        ts({
          ...
          htmlBuilder(e, t) {
            ...
            0 === r.height && (r.height = t.fontMetrics().xHeight),
              (r = e8.wrapFragment(r, t));
            var a = t.fontMetrics().defaultRuleThickness,
              n = a;
            t.style.id < N.TEXT.id && (n = t.fontMetrics().xHeight);
            var i = a + n / 4,
              s = r.height + r.depth + i + a,
              { span: o, ruleWidth: l, advanceWidth: h } = rv.sqrtImage(s, t),
              m = o.height - l;
            m > r.height + r.depth + i &&
              (i = (i + m - r.height - r.depth) / 2);
            var c = o.height - r.height - i - l;
            r.style.paddingLeft = J(h);
            var p = e8.makeVList(
              {
                positionType: "firstBaseline",
                children: [
          ...
          mathmlBuilder(e, t) {
            ...
            return a
              ? new tT.MathNode("mroot", [tR(r, t), tR(a, t)])
              : new tT.MathNode("msqrt", [tR(r, t)]);
          },
        });
      var r3 = {
        display: N.DISPLAY,
      ...
      var r8 = function (e, t) {
        ...
        return r
          ? "op" === r.type
            ? r.limits &&
              (t.style.size === N.DISPLAY.size || r.alwaysHandleSupSub)
              ? rQ
              : null
            : "operatorname" === r.type
      ...
      to({
        ...
        htmlBuilder(e, t) {
          var r,
            ...
            s = r8(e, t);
          if (s) return s(e, t);
          var { base: o, sup: l, sub: h } = e,
            m = tw(o, t),
            c = t.fontMetrics(),
            p = 0,
            u = 0,
            d = o && x.isCharacterBox(o);
          if (l) {
            ...
            (r = tw(l, g, t)),
              d ||
                (p =
                  m.height -
                  (g.fontMetrics().supDrop * g.sizeMultiplier) /
                    t.sizeMultiplier);
          }
          if (h) {
          ...
          n =
            t.style === N.DISPLAY ? c.sup1 : t.style.cramped ? c.sup3 : c.sup2;
          ...
          if (a) {
            ...
            (m instanceof eo || w) && (y = J(-m.italic));
          }
          if (r && a) {
            (p = Math.max(p, n, r.depth + 0.25 * c.xHeight)),
              (u = Math.max(u, c.sub2));
            var k = 4 * c.defaultRuleThickness;
            if (p - r.depth - (a.height - u) < k) {
              u = k - (p - r.depth) + a.height;
              var S = 0.8 * c.xHeight - (p - r.depth);
              S > 0 && ((p += S), (u -= S));
            }
            var M = [
              {
              ...
              { type: "elem", elem: r, shift: -p, marginRight: b },
            ];
            i = e8.makeVList(
          ...
          return e8.makeSpan([A], [m, e8.makeSpan(["msupsub"], [i])], t);
        },
        mathmlBuilder(e, t) {
          var r,
            a,
          ...
          var i = [tR(e.base, t)];
          if ((e.sub && i.push(tR(e.sub, t)), e.sup && i.push(tR(e.sup, t)), n))
            a = r ? "mover" : "munder";
          else if (e.sub) {
            if (e.sup) {
              var s = e.base;
        ...
        to({
          type: "atom",
          htmlBuilder: (e, t) =>
            e8.mathsym(e.text, e.mode, t, ["m" + e.family]),
          mathmlBuilder(e, t) {
            var r = new tT.MathNode("mo", [tB(e.text, e.mode)]);
            if ("bin" === e.family) {
              var a = tq(e, t);
      ...
      var r2 = { mi: "italic", mn: "normal", mtext: "normal" };
      to({
        type: "mathord",
        htmlBuilder: (e, t) => e8.makeOrd(e, t, "mathord"),
        mathmlBuilder(e, t) {
          var r = new tT.MathNode("mi", [tB(e.text, e.mode, t)]),
            a = tq(e, t) || "italic";
          return a !== r2[r.type] && r.setAttribute("mathvariant", a), r;
        },
      }),
        to({
          type: "textord",
          htmlBuilder: (e, t) => e8.makeOrd(e, t, "textord"),
          mathmlBuilder(e, t) {
            var r,
              a = tB(e.text, e.mode, t),
              n = tq(e, t) || "normal";
            return (
              n !==
                r2[
      ...
      to({
        type: "spacing",
        htmlBuilder(e, t) {
          if (ae.hasOwnProperty(e.text)) {
            var r = ae[e.text].className || "";
            if ("text" !== e.mode)
              return e8.makeSpan(
                ["mspace", r],
          ...
          if (r9.hasOwnProperty(e.text))
            return e8.makeSpan(["mspace", r9[e.text]], [], t);
          throw new i('Unknown type of space "' + e.text + '"');
        },
        mathmlBuilder(e, t) {
          var r;
          if (ae.hasOwnProperty(e.text))
            r = new tT.MathNode("mtext", [new tT.TextNode("\xa0")]);
          else if (r9.hasOwnProperty(e.text)) return new tT.MathNode("mspace");
      ...
      to({
        ...
        mathmlBuilder(e, t) {
          var r = new tT.MathNode("mtable", [
            new tT.MathNode("mtr", [
              at(),
              new tT.MathNode("mtd", [tI(e.body, t)]),
              at(),
              new tT.MathNode("mtd", [tI(e.tag, t)]),
            ]),
          ]);
      ...
      var ar = {
        ...
        aa = { "\\textbf": "textbf", "\\textmd": "textmd" },
        an = { "\\textit": "textit", "\\textup": "textup" },
        ai = (e, t) => {
          var r = e.font;
          return r
            ? ar[r]
      ...
      ts({
        ...
        handler(e, t) {
          var { parser: r, funcName: a } = e,
            n = t[0];
          return { type: "text", mode: r.mode, body: th(n), font: a };
        },
        htmlBuilder(e, t) {
          var r = ai(e, t),
            a = tg(e.body, r, !0);
          return e8.makeSpan(["mord", "text"], a, r);
        },
        mathmlBuilder(e, t) {
          var r = ai(e, t);
          return tI(e.body, r);
        ...
        ts({
          ...
          htmlBuilder(e, t) {
            var r = tw(e.body, t),
              a = e8.makeLineSpan("underline-line", t),
              n = t.fontMetrics().defaultRuleThickness,
              i = e8.makeVList(
                {
                  positionType: "top",
          ...
          mathmlBuilder(e, t) {
            var r = new tT.MathNode("mo", [new tT.TextNode("‾")]);
            r.setAttribute("stretchy", "true");
            var a = new tT.MathNode("munder", [tR(e.body, t), r]);
            return a.setAttribute("accentunder", "true"), a;
          },
        }),
        ts({
          ...
          mathmlBuilder: (e, t) =>
            new tT.MathNode("mpadded", [tR(e.body, t)], ["vcenter"]),
        }),
        ts({
          type: "verb",
          names: ["\\verb"],
          ...
          htmlBuilder(e, t) {
            for (
              var r = as(e), a = [], n = t.havingStyle(t.style.text()), i = 0;
              i < r.length;
              i++
            ) {
              var s = r[i];
          ...
          mathmlBuilder(e, t) {
            var r = new tT.TextNode(as(e)),
              a = new tT.MathNode("mtext", [r]);
            return a.setAttribute("mathvariant", "monospace"), a;
          },
        });
      var as = (e) => e.body.replace(/ /g, e.star ? "␣" : "\xa0"),
        ao = "[ \r\n	]",
        al = "[̀-ͯ]",
        ah = RegExp(al + "+$"),
        am =
      ...
      class ac {
        ...
        lex() {
          ...
          if (t === e.length) return new n("EOF", new a(this, t, t));
          ...
          return new n(s, new a(this, t, this.tokenRegex.lastIndex));
        }
      }
      class ap {
        constructor(e, t) {
      ...
      (rA["\\noexpand"] = function (e) {
        ...
        (rA["\\@ifstar"] = "\\@ifnextchar *{\\@firstoftwo{#1}}"),
        (rA["\\TextOrMath"] = function (e) {
      ...
      rA["\\char"] = function (e) {
        ...
        if ("'" === a.text) (t = 8), (a = e.popToken());
          ...
          else if ("EOF" === a.text) throw new i("\\char` missing argument");
          else n = a.text.charCodeAt(0);
        } else t = 10;
        if (t) {
          if (null == (n = au[a.text]) || n >= t)
            throw new i("Invalid base-" + t + " digit " + a.text);
          for (; null != (r = au[e.future().text]) && r < t; )
            (n *= t), (n += r), e.popToken();
        }
        return "\\@char{" + n + "}";
      };
      var ad = (e, t, r) => {
        ...
        return e.macros.set(n, { tokens: a, numArgs: o }), "";
      };
      (s = (e) => ad(e, !1, !0)),
        (rA["\\newcommand"] = s),
        (o = (e) => ad(e, !0, !1)),
        ...
        (c = (e) => {
          var t = e.popToken(),
            r = t.text;
          return (
            console.log(t, e.macros.get(r), ta[r], ed.math[r], ed.text[r]), ""
          );
        }),
        (rA["\\show"] = c),
        (rA["\\bgroup"] = "{"),
        ...
        (rA["\\AA"] = "\\r A"),
        (rA["\\textcopyright"] =
          "\\html@mathml{\\textcircled{c}}{\\char`\xa9}"),
        (rA["\\copyright"] =
        ...
        (rA["\\Bbbk"] = "\\Bbb{k}"),
        (rA["\xb7"] = "\\cdotp"),
        (rA["\\llap"] = "\\mathllap{\\textrm{#1}}"),
        (rA["\\rlap"] = "\\mathrlap{\\textrm{#1}}"),
        (rA["\\clap"] = "\\mathclap{\\textrm{#1}}"),
        (rA["\\mathstrut"] = "\\vphantom{(}"),
        (rA["\\underbar"] = "\\underline{\\text{#1}}"),
        (rA["\\not"] =
        ...
        (rA["\\vdots"] = "\\mathord{\\varvdots\\rule{0pt}{15pt}}"),
        (rA["⋮"] = "\\vdots"),
        (rA["\\varGamma"] = "\\mathit{\\Gamma}"),
        (rA["\\varDelta"] = "\\mathit{\\Delta}"),
        (rA["\\varTheta"] = "\\mathit{\\Theta}"),
        (rA["\\varLambda"] = "\\mathit{\\Lambda}"),
        (rA["\\varXi"] = "\\mathit{\\Xi}"),
        (rA["\\varPi"] = "\\mathit{\\Pi}"),
        (rA["\\varSigma"] = "\\mathit{\\Sigma}"),
        (rA["\\varUpsilon"] = "\\mathit{\\Upsilon}"),
        (rA["\\varPhi"] = "\\mathit{\\Phi}"),
        (rA["\\varPsi"] = "\\mathit{\\Psi}"),
        (rA["\\varOmega"] = "\\mathit{\\Omega}"),
        (rA["\\substack"] = "\\begin{subarray}{c}#1\\end{subarray}"),
        (rA["\\colon"] =
          "\\nobreak\\mskip2mu\\mathpunct{}\\mathchoice{\\mkern-3mu}{\\mkern-3mu}{}{}{:}\\mskip6mu\\relax"),
        (rA["\\boxed"] = "\\fbox{$\\displaystyle{#1}$}"),
        (rA["\\iff"] = "\\DOTSB\\;\\Longleftrightarrow\\;"),
        (rA["\\implies"] = "\\DOTSB\\;\\Longrightarrow\\;"),
        (rA["\\impliedby"] = "\\DOTSB\\;\\Longleftarrow\\;");
      var ag = {
        ",": "\\dotsc",
        "\\not": "\\dotsb",
        "+": "\\dotsb",
      ...
      (rA["\\dotso"] = function (e) {
        return e.future().text in af ? "\\ldots\\," : "\\ldots";
      }),
        (rA["\\dotsc"] = function (e) {
          var t = e.future().text;
          return t in af && "," !== t ? "\\ldots\\," : "\\ldots";
        }),
        (rA["\\cdots"] = function (e) {
          return e.future().text in af ? "\\@cdots\\," : "\\@cdots";
        }),
        (rA["\\dotsb"] = "\\cdots"),
        (rA["\\dotsm"] = "\\cdots"),
        (rA["\\dotsi"] = "\\!\\cdots"),
        ...
        (rA["\\DOTSB"] = "\\relax"),
        (rA["\\DOTSX"] = "\\relax"),
        (rA["\\tmspace"] = "\\TextOrMath{\\kern#1#3}{\\mskip#1#2}\\relax"),
        (rA["\\,"] = "\\tmspace+{3mu}{.1667em}"),
        (rA["\\thinspace"] = "\\,"),
        (rA["\\>"] = "\\mskip{4mu}"),
        (rA["\\:"] = "\\tmspace+{4mu}{.2222em}"),
        (rA["\\medspace"] = "\\:"),
        (rA["\\;"] = "\\tmspace+{5mu}{.2777em}"),
        (rA["\\thickspace"] = "\\;"),
        (rA["\\!"] = "\\tmspace-{3mu}{.1667em}"),
        (rA["\\negthinspace"] = "\\!"),
        ...
        (rA["\\enspace"] = "\\kern.5em "),
        (rA["\\enskip"] = "\\hskip.5em\\relax"),
        (rA["\\quad"] = "\\hskip1em\\relax"),
        (rA["\\qquad"] = "\\hskip2em\\relax"),
        (rA["\\tag"] = "\\@ifstar\\tag@literal\\tag@paren"),
        (rA["\\tag@paren"] = "\\tag@literal{({#1})}"),
        (p = (e) => {
      ...
      var av = J(P["Main-Regular"][84][1] - 0.7 * P["Main-Regular"][65][1]);
      (rA["\\LaTeX"] =
        ...
        (rA["\\hspace"] = "\\@ifstar\\@hspacer\\@hspace"),
        (rA["\\@hspace"] = "\\hskip #1\\relax"),
        (rA["\\@hspacer"] = "\\rule{0pt}{0pt}\\hskip #1\\relax"),
        (rA["\\ordinarycolon"] = ":"),
        (rA["\\vcentcolon"] = "\\mathrel{\\mathop\\ordinarycolon}"),
        (rA["\\dblcolon"] =
        ...
        (rA["⩴"] = "\\Coloneqq"),
        (rA["\\ratio"] = "\\vcentcolon"),
        (rA["\\coloncolon"] = "\\dblcolon"),
        (rA["\\colonequals"] = "\\coloneqq"),
        (rA["\\coloncolonequals"] = "\\Coloneqq"),
        (rA["\\equalscolon"] = "\\eqqcolon"),
        (rA["\\equalscoloncolon"] = "\\Eqqcolon"),
        (rA["\\colonminus"] = "\\coloneq"),
        (rA["\\coloncolonminus"] = "\\Coloneq"),
        (rA["\\minuscolon"] = "\\eqcolon"),
        (rA["\\minuscoloncolon"] = "\\Eqcolon"),
        (rA["\\coloncolonapprox"] = "\\Colonapprox"),
        (rA["\\coloncolonsim"] = "\\Colonsim"),
        (rA["\\simcolon"] =
        ...
        (rA["\\notni"] = "\\html@mathml{\\not\\ni}{\\mathrel{\\char`∌}}"),
        (rA["\\limsup"] = "\\DOTSB\\operatorname*{lim\\,sup}"),
        (rA["\\liminf"] = "\\DOTSB\\operatorname*{lim\\,inf}"),
        (rA["\\injlim"] = "\\DOTSB\\operatorname*{inj\\,lim}"),
        (rA["\\projlim"] = "\\DOTSB\\operatorname*{proj\\,lim}"),
        (rA["\\varlimsup"] = "\\DOTSB\\operatorname*{\\overline{lim}}"),
        (rA["\\varliminf"] = "\\DOTSB\\operatorname*{\\underline{lim}}"),
        (rA["\\varinjlim"] = "\\DOTSB\\operatorname*{\\underrightarrow{lim}}"),
        (rA["\\varprojlim"] = "\\DOTSB\\operatorname*{\\underleftarrow{lim}}"),
        (rA["\\gvertneqq"] = "\\html@mathml{\\@gvertneqq}{≩}"),
        (rA["\\lvertneqq"] = "\\html@mathml{\\@lvertneqq}{≨}"),
        ...
        (rA["\\varsubsetneq"] = "\\html@mathml{\\@varsubsetneq}{⊊}"),
        (rA["\\varsubsetneqq"] = "\\html@mathml{\\@varsubsetneqq}{⫋}"),
        (rA["\\varsupsetneq"] = "\\html@mathml{\\@varsupsetneq}{⊋}"),
        (rA["\\varsupsetneqq"] = "\\html@mathml{\\@varsupsetneqq}{⫌}"),
        (rA["\\imath"] = "\\html@mathml{\\@imath}{ı}"),
        (rA["\\jmath"] = "\\html@mathml{\\@jmath}{ȷ}"),
        (rA["\\llbracket"] =
        ...
        (rA["\\Complex"] = "\\mathbb{C}"),
        (rA["\\Dagger"] = "\\ddagger"),
        (rA["\\diamonds"] = "\\diamondsuit"),
        (rA["\\empty"] = "\\emptyset"),
        (rA["\\Epsilon"] = "\\mathrm{E}"),
        (rA["\\Eta"] = "\\mathrm{H}"),
        (rA["\\exist"] = "\\exists"),
        (rA["\\harr"] = "\\leftrightarrow"),
        (rA["\\hArr"] = "\\Leftrightarrow"),
        (rA["\\Harr"] = "\\Leftrightarrow"),
        (rA["\\hearts"] = "\\heartsuit"),
        (rA["\\image"] = "\\Im"),
        ...
        (rA["\\weierp"] = "\\wp"),
        (rA["\\Zeta"] = "\\mathrm{Z}"),
        (rA["\\argmin"] = "\\DOTSB\\operatorname*{arg\\,min}"),
        (rA["\\argmax"] = "\\DOTSB\\operatorname*{arg\\,max}"),
        (rA["\\plim"] = "\\DOTSB\\mathop{\\operatorname{plim}}\\limits"),
        (rA["\\bra"] = "\\mathinner{\\langle{#1}|}"),
        (rA["\\ket"] = "\\mathinner{|{#1}\\rangle}"),
        (rA["\\braket"] = "\\mathinner{\\langle{#1}\\rangle}"),
        (rA["\\Bra"] = "\\left\\langle#1\\right|"),
        (rA["\\Ket"] = "\\left|#1\\right\\rangle");
      var ab = (e) => (t) => {
      ...
      (u = ab(!1)),
        ...
        (rA["\\set"] = "\\bra@set{\\{\\,}{\\mid}{}{\\,\\}}"),
        (rA["\\angln"] = "{\\angl n}"),
        (rA["\\blue"] = "\\textcolor{##6495ed}{#1}"),
        (rA["\\orange"] = "\\textcolor{##ffa500}{#1}"),
        (rA["\\pink"] = "\\textcolor{##ff00af}{#1}"),
        (rA["\\red"] = "\\textcolor{##df0030}{#1}"),
        (rA["\\green"] = "\\textcolor{##28ae7b}{#1}"),
        (rA["\\gray"] = "\\textcolor{gray}{#1}"),
        (rA["\\purple"] = "\\textcolor{##9d38bd}{#1}"),
        (rA["\\blueA"] = "\\textcolor{##ccfaff}{#1}"),
        (rA["\\blueB"] = "\\textcolor{##80f6ff}{#1}"),
        (rA["\\blueC"] = "\\textcolor{##63d9ea}{#1}"),
        (rA["\\blueD"] = "\\textcolor{##11accd}{#1}"),
        (rA["\\blueE"] = "\\textcolor{##0c7f99}{#1}"),
        (rA["\\tealA"] = "\\textcolor{##94fff5}{#1}"),
        (rA["\\tealB"] = "\\textcolor{##26edd5}{#1}"),
        (rA["\\tealC"] = "\\textcolor{##01d1c1}{#1}"),
        (rA["\\tealD"] = "\\textcolor{##01a995}{#1}"),
        (rA["\\tealE"] = "\\textcolor{##208170}{#1}"),
        (rA["\\greenA"] = "\\textcolor{##b6ffb0}{#1}"),
        (rA["\\greenB"] = "\\textcolor{##8af281}{#1}"),
        (rA["\\greenC"] = "\\textcolor{##74cf70}{#1}"),
        (rA["\\greenD"] = "\\textcolor{##1fab54}{#1}"),
        (rA["\\greenE"] = "\\textcolor{##0d923f}{#1}"),
        (rA["\\goldA"] = "\\textcolor{##ffd0a9}{#1}"),
        (rA["\\goldB"] = "\\textcolor{##ffbb71}{#1}"),
        (rA["\\goldC"] = "\\textcolor{##ff9c39}{#1}"),
        (rA["\\goldD"] = "\\textcolor{##e07d10}{#1}"),
        (rA["\\goldE"] = "\\textcolor{##a75a05}{#1}"),
        (rA["\\redA"] = "\\textcolor{##fca9a9}{#1}"),
        (rA["\\redB"] = "\\textcolor{##ff8482}{#1}"),
        (rA["\\redC"] = "\\textcolor{##f9685d}{#1}"),
        (rA["\\redD"] = "\\textcolor{##e84d39}{#1}"),
        (rA["\\redE"] = "\\textcolor{##bc2612}{#1}"),
        (rA["\\maroonA"] = "\\textcolor{##ffbde0}{#1}"),
        (rA["\\maroonB"] = "\\textcolor{##ff92c6}{#1}"),
        (rA["\\maroonC"] = "\\textcolor{##ed5fa6}{#1}"),
        (rA["\\maroonD"] = "\\textcolor{##ca337c}{#1}"),
        (rA["\\maroonE"] = "\\textcolor{##9e034e}{#1}"),
        (rA["\\purpleA"] = "\\textcolor{##ddd7ff}{#1}"),
        (rA["\\purpleB"] = "\\textcolor{##c6b9fc}{#1}"),
        (rA["\\purpleC"] = "\\textcolor{##aa87ff}{#1}"),
        (rA["\\purpleD"] = "\\textcolor{##7854ab}{#1}"),
        (rA["\\purpleE"] = "\\textcolor{##543b78}{#1}"),
        (rA["\\mintA"] = "\\textcolor{##f5f9e8}{#1}"),
        (rA["\\mintB"] = "\\textcolor{##edf2df}{#1}"),
        (rA["\\mintC"] = "\\textcolor{##e0e5cc}{#1}"),
        (rA["\\grayA"] = "\\textcolor{##f6f7f7}{#1}"),
        (rA["\\grayB"] = "\\textcolor{##f0f1f2}{#1}"),
        (rA["\\grayC"] = "\\textcolor{##e3e5e6}{#1}"),
        (rA["\\grayD"] = "\\textcolor{##d6d8da}{#1}"),
        (rA["\\grayE"] = "\\textcolor{##babec2}{#1}"),
        (rA["\\grayF"] = "\\textcolor{##888d93}{#1}"),
        (rA["\\grayG"] = "\\textcolor{##626569}{#1}"),
        (rA["\\grayH"] = "\\textcolor{##3b3e40}{#1}"),
        (rA["\\grayI"] = "\\textcolor{##21242c}{#1}"),
        (rA["\\kaBlue"] = "\\textcolor{##314453}{#1}"),
        (rA["\\kaGreen"] = "\\textcolor{##71B307}{#1}");
      var ay = { "^": !0, _: !0, "\\limits": !0, "\\nolimits": !0 };
      class ax {
        constructor(e, t, r) {
          (this.settings = void 0),
            ...
            this.feed(e),
            (this.macros = new ap(rA, t.macros)),
            (this.mode = r),
            (this.stack = []);
        }
        feed(e) {
          this.lexer = new ac(e, this.settings);
        }
        switchMode(e) {
          this.mode = e;
        }
        ...
        consumeArgs(e, t) {
          if (t) {
            ...
            for (var r = t[0], a = 0; a < r.length; a++) {
              var n = this.popToken();
              if (r[a] !== n.text)
                throw new i("Use of the macro doesn't match its definition", n);
            }
          }
          for (var s = [], o = 0; o < e; o++)
        ...
        expandOnce(e) {
          ...
          if (a.numArgs) {
            ...
            for (var o = n.length - 1; o >= 0; --o) {
              ...
              if ("#" === l.text) {
                if (0 === o)
                  throw new i("Incomplete placeholder at end of macro body", l);
                if ("#" === (l = n[--o]).text) n.splice(o + 1, 1);
                else if (/^[1-9]$/.test(l.text))
                  n.splice(o, 2, ...s[+l.text - 1]);
                else throw new i("Not a valid argument number", l);
              }
            }
          }
        ...
        expandMacro(e) {
          return this.macros.has(e) ? this.expandTokens([new n(e)]) : void 0;
        }
        expandTokens(e) {
          var t = [],
            r = this.stack.length;
        ...
        isDefined(e) {
          return (
            this.macros.has(e) ||
            ta.hasOwnProperty(e) ||
            ed.math.hasOwnProperty(e) ||
            ed.text.hasOwnProperty(e) ||
            ay.hasOwnProperty(e)
          );
        }
        isExpandable(e) {
          ...
          return null != t
            ...
            : ta.hasOwnProperty(e) && !ta[e].primitive;
        }
      }
      var aw = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/,
        ak = Object.freeze({
          "₊": "+",
          "₋": "-",
          "₌": "=",
      ...
      class az {
        constructor(e, t) {
          (this.mode = void 0),
            ...
            (this.mode = "math"),
            (this.gullet = new ax(e, t, this.mode)),
            (this.settings = t),
        ...
        parseExpression(e, t) {
          for (var r = []; ; ) {
            ...
            var a = this.fetch();
            if (
              -1 !== az.endOfExpression.indexOf(a.text) ||
              (t && a.text === t) ||
              (e && ta[a.text] && ta[a.text].infix)
            )
              break;
        ...
        handleInfixNodes(e) {
          for (var t = -1, r = 0; r < e.length; r++)
            if ("infix" === e[r].type) {
              if (-1 !== t)
                throw new i("only one infix operator per group", e[r].token);
              (t = r), (a = e[r].replaceWith);
            }
          if (-1 === t || !a) return e;
          var a,
            n,
          ...
          return (
            ...
            [
              "\\\\abovefrac" === a
                ? this.callFunction(a, [n, e[t], s], [])
                : this.callFunction(a, [n, s], []),
            ]
          );
        }
        handleSupSubscript(e) {
          ...
          if (!a) throw new i("Expected group after '" + r + "'", t);
          return a;
        }
        ...
        parseAtom(e) {
          ...
          for (;;) {
            ...
            if ("\\limits" === n.text || "\\nolimits" === n.text) {
              ...
              else throw new i("Limit controls must follow a math operator", n);
              this.consume();
            } else if ("^" === n.text) {
              if (t) throw new i("Double superscript", n);
              ...
              "^" === this.fetch().text &&
                ...
                (t = { type: "ordgroup", mode: this.mode, body: l });
            } else if (ak[n.text]) {
              var h = ak[n.text],
                m = aw.test(n.text);
              for (this.consume(); ; ) {
                var c = this.fetch().text;
                if (!ak[c] || aw.test(c) !== m) break;
                this.consume(), (h += ak[c]);
              }
              var p = new az(h, this.settings).parse();
              m
                ? (r = { type: "ordgroup", mode: "math", body: p })
                : (t = { type: "ordgroup", mode: "math", body: p });
            } else break;
          }
          return t || r
        ...
        parseFunction(e, t) {
          ...
          } else throw new i("Can't use function '" + a + "' in text mode", r);
          var { args: s, optArgs: o } = this.parseArguments(a, n);
        ...
        parseArguments(e, t) {
          ...
          for (var a = [], n = [], s = 0; s < r; s++) {
            var o = t.argTypes && t.argTypes[s],
              l = s < t.numOptionalArgs;
            ((t.primitive && null == o) ||
              ("sqrt" === t.type && 1 === s && null == n[0])) &&
              (o = "primitive");
            var h = this.parseGroupOfType("argument to '" + e + "'", o, l);
            if (l) n.push(h);
            else if (null != h) a.push(h);
        ...
        parseStringGroup(e, t) {
          var r,
            a = this.gullet.scanArgument(t);
          if (null == a) return null;
          for (var n = ""; "EOF" !== (r = this.fetch()).text; )
        ...
        parseSizeGroup(e) {
          ...
          if (!a) throw new i("Invalid size: '" + t.text + "'", t);
          var n = { number: +(a[1] + a[2]), unit: a[3] };
          if (!Z(n)) throw new i("Invalid unit: '" + n.unit + "'", t);
        ...
        parseGroup(e, t) {
          ...
          if ("{" === s || "\\begingroup" === s) {
            ...
            null == (r = this.parseFunction(t, e) || this.parseSymbol()) &&
            "\\" === s[0] &&
            !ay.hasOwnProperty(s)
          ) {
            if (this.settings.throwOnError)
              throw new i("Undefined control sequence: " + s, n);
        ...
        parseSymbol() {
          ...
          if (
            ...
            var o,
              ...
              h = a.range(e);
            o = ep.hasOwnProperty(l)
              ? { type: "atom", mode: this.mode, family: l, loc: h, text: t }
              : { type: l, mode: this.mode, loc: h, text: t };
          } else {
          ...
          if ((this.consume(), s))
            for (var m = 0; m < s[0].length; m++) {
              var c = s[0][m];
              if (!aS[c]) throw new i("Unknown accent ' " + c + "'", e);
              var p = aS[c][this.mode] || aS[c].text;
              if (!p)
                throw new i(
      ...
      az.endOfExpression = ["}", "\\endgroup", "\\end", "\\right", "&"];
      var aA = function (e, t) {
      ...
      var aB = function (e, t, r) {
          if (r.throwOnError || !(e instanceof i)) throw e;
          var a = e8.makeSpan(["katex-error"], [new eo(t)]);
          return (
